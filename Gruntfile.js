...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		concat: {
			...
			runtime: {
				src: [ 'src/Anglebars.js', 'src/types.js', 'src/events.js', 'src/formatters.js', 'src/ViewModel.js', 'src/DomViews.js', 'src/TextViews.js', 'src/extend.js', 'src/modifyArray.js', 'src/easing.js', 'src/animate.js' ],
				dest: 'build/runtime/Anglebars.runtime.js'
			},
			full: {
				src: [ 'src/Anglebars.js', 'src/types.js', 'src/events.js', 'src/compile.js', 'src/tokenize.js', 'src/formatters.js', 'src/ViewModel.js', 'src/DomViews.js', 'src/TextViews.js', 'src/extend.js', 'src/modifyArray.js', 'src/easing.js', 'src/animate.js' ],
