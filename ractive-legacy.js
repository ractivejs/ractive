(function (global, factory) {
	...
	var interpolate__default = interpolate;
	...
	var interpolators__default = interpolators;
	...
	var TransitionManager__default = TransitionManager;
	...
	var Animation__default = Animation;
	...
	var eventStack__default = eventStack;
	...
	var Observer__default = Observer;
	...
	var PatternObserver__default = PatternObserver;
	...
	var arrayAdaptor__default = arrayAdaptor;
	...
	var magicAdaptor__default = magicAdaptor;
	...
	var magicArrayAdaptor__default = magicArrayAdaptor;
	...
	var adaptConfigurator__default = adaptConfigurator;
	...
	var cssConfigurator__default = cssConfigurator;
	//# sourceMappingURL=01-_6to5-css.js.map
	...
	var dataConfigurator__default = dataConfigurator;
	...
	var getTypeof__default = getTypeof;
	...
	var getLogicalOr__default = getLogicalOr;
	...
	var mustacheType = function (parser) {
	...
	var mustacheContent = function (parser, delimiterType) {
	  ...
	  if (mustache.contextPartialExpression) {
	    mustache.contextPartialExpression = [refineExpression(parser, mustache.contextPartialExpression, { t: PARTIAL })];
	  }
	...
	function refineExpression(parser, expression, mustache) {
	  ...
	  if (expression) {
	    ...
	    if (expression.t === REFERENCE) {
	      ...
	      if (expression.t === NUMBER_LITERAL && mustacheContent__arrayMemberPattern.test(expression.v)) {
	...
	var getMustache__default = getMustache;
	...
	var getPartial__default = getPartial;
	...
	var getClosingTag = function (parser) {
	  var tag;
	...
	var getAttribute__default = getAttribute;
	...
	ExpressionParser = Parser.extend({
	  converters: [getConditional]
	});

	// TODO clean this up, it's shocking
	var processDirective = function (tokens) {
	...
	var stripStandalones = function (items) {
	  ...
	  for (i = 1; i < items.length; i += 1) {
	    ...
	    if (stripStandalones__isSection(current) && isString(backOne)) {
	    ...
	    if (isString(current) && stripStandalones__isSection(backOne)) {
	...
	var templateConfigurator__default = templateConfigurator;
	...
	var registries__default = registries;
	...
	var ReferenceResolver__default = ReferenceResolver;
	...
	var SpecialResolver__default = SpecialResolver;
	...
	var IndexResolver__default = IndexResolver;
	//# sourceMappingURL=01-_6to5-IndexResolver.js.map

	var findIndexRefs__default = findIndexRefs;
	...
	var ExpressionResolver__default = ExpressionResolver;
	...
	var MemberResolver__default = MemberResolver;
	...
	var ReferenceExpressionResolver__default = ReferenceExpressionResolver;
	...
	var Interpolator__default = Interpolator;
	...
	var Attribute__default = Attribute;
	...
	var ConditionalAttribute__default = ConditionalAttribute;
	...
	var ContentEditableBinding__default = ContentEditableBinding;
	...
	var RadioBinding__default = RadioBinding;
	...
	var RadioNameBinding__default = RadioNameBinding;
	...
	var CheckboxNameBinding__default = CheckboxNameBinding;
	...
	var CheckboxBinding__default = CheckboxBinding;
	...
	var SelectBinding__default = SelectBinding;
	...
	var MultipleSelectBinding__default = MultipleSelectBinding;
	...
	var FileListBinding__default = FileListBinding;
	...
	var GenericBinding__default = GenericBinding;
	...
	var EventHandler__default = EventHandler;
	...
	var Decorator__default = Decorator;
	...
	var getStyle__default = getStyle;
	...
	var createTransitions__default = createTransitions;
	...
	var visibility__default = visibility;
	...
	var animateStyle__default = animateStyle;
	...
	var Transition__default = Transition;
	...
	var notifyPatternObservers__default = notifyPatternObservers;
	...
	var UnresolvedDependency__default = UnresolvedDependency;
	...
	var Computation__default = Computation;
	...
	var DataTracker__default = DataTracker;
	...
	var Viewmodel__default = Viewmodel;
	...
	var HookQueue__default = HookQueue;
	...
	var ComplexParameter__default = ComplexParameter;
	...
	var ParameterResolver__default = ParameterResolver;
	...
	var Fragment__default = Fragment;
