...
(function (global, factory) {
  ...
  //# sourceMappingURL=01-_6to5-easing.js.map
	...
	var utils_hasOwnProperty__default = Object.prototype.hasOwnProperty;
	//# sourceMappingURL=01-_6to5-hasOwnProperty.js.map

  "use strict";
  
  var isArray__toString = Object.prototype.toString;
  
  // thanks, http://perfectionkills.com/instanceof-considered-harmful-or-how-to-write-a-robust-isarray/
  var isArray__default = function (thing) {
    return isArray__toString.call(thing) === "[object Array]";
  };
  //# sourceMappingURL=01-_6to5-isArray.js.map

  "use strict";
  
  var isObject__toString = Object.prototype.toString;
  
  var isObject__default = function (thing) {
    return (thing && isObject__toString.call(thing) === "[object Object]");
  };
  //# sourceMappingURL=01-_6to5-isObject.js.map

  "use strict";
  
  // http://stackoverflow.com/questions/18082/validate-numbers-in-javascript-isnumeric
  var isNumeric__default = function (thing) {
    return !isNaN(parseFloat(thing)) && isFinite(thing);
  };
  //# sourceMappingURL=01-_6to5-isNumeric.js.map
  ...
  //# sourceMappingURL=01-_6to5-errors.js.map
	...
	var isClient__isClient = (typeof document === "object");
	var isClient__default = isClient__isClient;
	//# sourceMappingURL=01-_6to5-isClient.js.map
  ...
  try {
    ...
    create__create = Object.create;
  } catch (err) {
    // sigh
    create__create = (function () {
      var F = function () {};
  ...
  var create__default = create__create;
  //# sourceMappingURL=01-_6to5-create.js.map
  ...
  var getNumberLiteral__default = function (parser) {
    ...
    if (result = parser.matchPattern(getNumberLiteral__numberPattern)) {
      return {
        t: types__default.NUMBER_LITERAL,
        v: result
      };
    }
  ...
  var getBooleanLiteral__default = function (parser) {
    ...
    if (remaining.substr(0, 4) === "true") {
      parser.pos += 4;
      return {
        t: types__default.BOOLEAN_LITERAL,
        v: "true"
      };
    }
  ...
  var getStringLiteral__default = function (parser) {
    ...
    if (parser.matchString("\"")) {
      ...
      return {
        t: types__default.STRING_LITERAL,
        v: string
      };
    }
  ...
  var getKeyValuePair__default = function (parser) {
    ...
    return {
      t: types__default.KEY_VALUE_PAIR,
      k: key,
      v: value
    };
  };
  ...
  var getObjectLiteral__default = function (parser) {
    ...
    return {
      t: types__default.OBJECT_LITERAL,
      m: keyValuePairs
    };
  };
  ...
  var getArrayLiteral__default = function (parser) {
    ...
    return {
      t: types__default.ARRAY_LITERAL,
      m: expressionList
    };
  };
  ...
  getTypeof__makePrefixSequenceMatcher = function (symbol, fallthrough) {
    return function (parser) {
      ...
      return {
        s: symbol,
        o: expression,
        t: types__default.PREFIX_OPERATOR
      };
    };
  };
  ...
  getLogicalOr__makeInfixSequenceMatcher = function (symbol, fallthrough) {
    return function (parser) {
      ...
      while (true) {
        ...
        left = {
          t: types__default.INFIX_OPERATOR,
          s: symbol,
          o: [left, right]
        };
  ...
  function flattenExpression__extractRefs(node, refs) {
    ...
    if (node.t === types__default.REFERENCE) {
  ...
  function flattenExpression__stringify(parser, node, refs) {
    ...
    switch (node.t) {
      case types__default.BOOLEAN_LITERAL:
      case types__default.GLOBAL:
      case types__default.NUMBER_LITERAL:
        return node.v;
  
      case types__default.STRING_LITERAL:
        return flattenExpression__quoteStringLiteral(node.v);
  
      case types__default.ARRAY_LITERAL:
        return "[" + (node.m ? node.m.map(stringifyAll).join(",") : "") + "]";
  
      case types__default.OBJECT_LITERAL:
        return "{" + (node.m ? node.m.map(stringifyAll).join(",") : "") + "}";
  
      case types__default.KEY_VALUE_PAIR:
        return node.k + ":" + flattenExpression__stringify(parser, node.v, refs);
  
      case types__default.PREFIX_OPERATOR:
        return (node.s === "typeof" ? "typeof " : node.s) + flattenExpression__stringify(parser, node.o, refs);
  
      case types__default.INFIX_OPERATOR:
  ...
  Parser__Parser.extend = function (proto) {
    ...
    Child.prototype = create__default(Parent.prototype);
  
    for (key in proto) {
      if (utils_hasOwnProperty__default.call(proto, key)) {
  ...
  var mustacheType__mustacheTypes = {
    "#": types__default.SECTION,
    "^": types__default.INVERTED,
    "/": types__default.CLOSING,
    ">": types__default.PARTIAL,
    "!": types__default.COMMENT,
    "&": types__default.TRIPLE
  };
  ...
  var handlebarsBlockCodes__default = {
    each: types__default.SECTION_EACH,
    "if": types__default.SECTION_IF,
    "if-with": types__default.SECTION_IF_WITH,
    "with": types__default.SECTION_WITH,
    unless: types__default.SECTION_UNLESS,
    partial: types__default.SECTION_PARTIAL
  };
  ...
  var mustacheContent__default = function (parser, delimiterType) {
    ...
    if (delimiterType.isTriple) {
      mustache.t = types__default.TRIPLE;
    } else {
      ...
      if (parser.remaining()[0] === "!") {
        try {
          ...
          if (parser.remaining().indexOf(delimiters[1])) {
            ...
            mustache.t = types__default.INTERPOLATOR;
          }
        } catch (err) {}
      ...
      if (!expression) {
        ...
        mustache.t = type || types__default.INTERPOLATOR; // default
  
        // See if there's an explicit section type e.g. {{#with}}...{{/with}}
        if (type === types__default.SECTION) {
        ...
        else if (type === types__default.COMMENT || type === types__default.CLOSING) {
    ...
    if (!expression) {
      ...
      if (type === types__default.PARTIAL) {
      ...
      // look for named yields
      else if (mustache.t === types__default.INTERPOLATOR && parser.matchString("yield ")) {
        parser.allowWhitespace();
        mustache.r = "yield";
        relaxed = parser.relaxedNames;
        parser.relaxedNames = true;
        ...
        if (expression && expression.t === types__default.REFERENCE) {
      ...
      else if (mustache.t === types__default.SECTION && mustache.n === "partial") {
        relaxed = parser.relaxedNames;
        parser.relaxedNames = true;
        expression = parser.readExpression();
        parser.relaxedNames = false;
      ...
      // the reference
      var temp;
      if (mustache.t === types__default.PARTIAL && expression && (temp = parser.readExpression())) {
        mustache = {
    ...
    if (mustache.contextPartialExpression) {
      mustache.contextPartialExpression = [mustacheContent__refineExpression(parser, mustache.contextPartialExpression, { t: types__default.PARTIAL })];
    }
  ...
  function mustacheContent__refineExpression(parser, expression, mustache) {
    ...
    if (expression) {
      while (expression.t === types__default.BRACKETED && expression.x) {
        expression = expression.x;
      }
  
      // special case - integers should be treated as array members references,
      // rather than as expressions in their own right
      if (expression.t === types__default.REFERENCE) {
        mustache.r = expression.n;
      } else {
        if (expression.t === types__default.NUMBER_LITERAL && mustacheContent__arrayMemberPattern.test(expression.v)) {
  ...
  function mustacheContent__getReferenceExpression(parser, expression) {
    ...
    while (expression.t === types__default.MEMBER && expression.r.t === types__default.REFINEMENT) {
      refinement = expression.r;
  
      if (refinement.x) {
        if (refinement.x.t === types__default.REFERENCE) {
  ...
  var getMustache__delimiterChangeToken = { t: types__default.DELIMCHANGE, exclude: true };
  ...
  function getMustache__getMustacheOfType(parser, delimiterType) {
    ...
    if (mustache.t === types__default.COMMENT) {
      mustache.exclude = true;
    }
  
    if (mustache.t === types__default.CLOSING) {
    ...
    if (mustache.contextPartialExpression) {
      ...
      mustache.t = types__default.SECTION;
      mustache.n = "with";
    ...
    // section children
      ...
      while (child = parser.read()) {
        if (child.t === types__default.CLOSING) {
        ...
        if (child.t === types__default.INTERPOLATOR && child.r === "else") {
    ...
    } else if (mustache.t === types__default.INVERTED) {
      mustache.t = types__default.SECTION;
      mustache.n = types__default.SECTION_UNLESS;
    }
  
    // special case inline partial section
    if (mustache.n === types__default.SECTION_PARTIAL) {
      ...
      return {
        n: mustache.r,
        f: mustache.f,
        t: types__default.INLINE_PARTIAL
      };
    }
  ...
  function getMustache__isSection(mustache) {
    return mustache.t === types__default.SECTION || mustache.t === types__default.INVERTED;
  }
  ...
  //# sourceMappingURL=01-_6to5-comment.js.map
	...
	var voidElementNames__voidElementNames = /^(?:area|base|br|col|command|doctype|embed|hr|img|input|keygen|link|meta|param|source|track|wbr)$/i;
	var voidElementNames__default = voidElementNames__voidElementNames;
	//# sourceMappingURL=01-_6to5-voidElementNames.js.map
  ...
  var decodeCharacterReferences__htmlEntities, decodeCharacterReferences__controlCharacters, decodeCharacterReferences__entityPattern;
  
  decodeCharacterReferences__htmlEntities = { quot: 34, amp: 38, apos: 39, lt: 60, gt: 62, nbsp: 160, iexcl: 161, cent: 162, pound: 163, curren: 164, yen: 165, brvbar: 166, sect: 167, uml: 168, copy: 169, ordf: 170, laquo: 171, not: 172, shy: 173, reg: 174, macr: 175, deg: 176, plusmn: 177, sup2: 178, sup3: 179, acute: 180, micro: 181, para: 182, middot: 183, cedil: 184, sup1: 185, ordm: 186, raquo: 187, frac14: 188, frac12: 189, frac34: 190, iquest: 191, Agrave: 192, Aacute: 193, Acirc: 194, Atilde: 195, Auml: 196, Aring: 197, AElig: 198, Ccedil: 199, Egrave: 200, Eacute: 201, Ecirc: 202, Euml: 203, Igrave: 204, Iacute: 205, Icirc: 206, Iuml: 207, ETH: 208, Ntilde: 209, Ograve: 210, Oacute: 211, Ocirc: 212, Otilde: 213, Ouml: 214, times: 215, Oslash: 216, Ugrave: 217, Uacute: 218, Ucirc: 219, Uuml: 220, Yacute: 221, THORN: 222, szlig: 223, agrave: 224, aacute: 225, acirc: 226, atilde: 227, auml: 228, aring: 229, aelig: 230, ccedil: 231, egrave: 232, eacute: 233, ecirc: 234, euml: 235, igrave: 236, iacute: 237, icirc: 238, iuml: 239, eth: 240, ntilde: 241, ograve: 242, oacute: 243, ocirc: 244, otilde: 245, ouml: 246, divide: 247, oslash: 248, ugrave: 249, uacute: 250, ucirc: 251, uuml: 252, yacute: 253, thorn: 254, yuml: 255, OElig: 338, oelig: 339, Scaron: 352, scaron: 353, Yuml: 376, fnof: 402, circ: 710, tilde: 732, Alpha: 913, Beta: 914, Gamma: 915, Delta: 916, Epsilon: 917, Zeta: 918, Eta: 919, Theta: 920, Iota: 921, Kappa: 922, Lambda: 923, Mu: 924, Nu: 925, Xi: 926, Omicron: 927, Pi: 928, Rho: 929, Sigma: 931, Tau: 932, Upsilon: 933, Phi: 934, Chi: 935, Psi: 936, Omega: 937, alpha: 945, beta: 946, gamma: 947, delta: 948, epsilon: 949, zeta: 950, eta: 951, theta: 952, iota: 953, kappa: 954, lambda: 955, mu: 956, nu: 957, xi: 958, omicron: 959, pi: 960, rho: 961, sigmaf: 962, sigma: 963, tau: 964, upsilon: 965, phi: 966, chi: 967, psi: 968, omega: 969, thetasym: 977, upsih: 978, piv: 982, ensp: 8194, emsp: 8195, thinsp: 8201, zwnj: 8204, zwj: 8205, lrm: 8206, rlm: 8207, ndash: 8211, mdash: 8212, lsquo: 8216, rsquo: 8217, sbquo: 8218, ldquo: 8220, rdquo: 8221, bdquo: 8222, dagger: 8224, Dagger: 8225, bull: 8226, hellip: 8230, permil: 8240, prime: 8242, Prime: 8243, lsaquo: 8249, rsaquo: 8250, oline: 8254, frasl: 8260, euro: 8364, image: 8465, weierp: 8472, real: 8476, trade: 8482, alefsym: 8501, larr: 8592, uarr: 8593, rarr: 8594, darr: 8595, harr: 8596, crarr: 8629, lArr: 8656, uArr: 8657, rArr: 8658, dArr: 8659, hArr: 8660, forall: 8704, part: 8706, exist: 8707, empty: 8709, nabla: 8711, isin: 8712, notin: 8713, ni: 8715, prod: 8719, sum: 8721, minus: 8722, lowast: 8727, radic: 8730, prop: 8733, infin: 8734, ang: 8736, and: 8743, or: 8744, cap: 8745, cup: 8746, int: 8747, there4: 8756, sim: 8764, cong: 8773, asymp: 8776, ne: 8800, equiv: 8801, le: 8804, ge: 8805, sub: 8834, sup: 8835, nsub: 8836, sube: 8838, supe: 8839, oplus: 8853, otimes: 8855, perp: 8869, sdot: 8901, lceil: 8968, rceil: 8969, lfloor: 8970, rfloor: 8971, lang: 9001, rang: 9002, loz: 9674, spades: 9824, clubs: 9827, hearts: 9829, diams: 9830 };
  decodeCharacterReferences__controlCharacters = [8364, 129, 8218, 402, 8222, 8230, 8224, 8225, 710, 8240, 352, 8249, 338, 141, 381, 143, 144, 8216, 8217, 8220, 8221, 8226, 8211, 8212, 732, 8482, 353, 8250, 339, 157, 382, 376];
  decodeCharacterReferences__entityPattern = new RegExp("&(#?(?:x[\\w\\d]+|\\d+|" + Object.keys(decodeCharacterReferences__htmlEntities).join("|") + "));?", "g");
  
  function decodeCharacterReferences__decodeCharacterReferences(html) {
    return html.replace(decodeCharacterReferences__entityPattern, function (match, entity) {
      var code;
  
      // Handle named entities
      if (entity[0] !== "#") {
        code = decodeCharacterReferences__htmlEntities[entity];
      } else if (entity[1] === "x") {
      ...
      return String.fromCharCode(decodeCharacterReferences__validateCode(code));
    });
  };
  var decodeCharacterReferences__default = decodeCharacterReferences__decodeCharacterReferences;
  ...
  function decodeCharacterReferences__validateCode(code) {
    if (!code) {
      return 65533;
    }
    ...
    if (code <= 159) {
      return decodeCharacterReferences__controlCharacters[code - 128];
    }
  ...
  //# sourceMappingURL=01-_6to5-decodeCharacterReferences.js.map
  ...
  var getText__default = function (parser) {
    ...
    return parser.inside ? remaining.substr(0, index) : decodeCharacterReferences__default(remaining.substr(0, index));
  };
  ...
  function getAttribute__getAttributeValue(parser) {
    ...
    if (value.length === 1 && typeof value[0] === "string") {
      return decodeCharacterReferences__default(value[0]);
    }
  ...
  function element__getElement(parser) {
    ...
    if (parser.matchString("!")) {
      element.t = types__default.DOCTYPE;
    ...
    element.t = types__default.ELEMENT;
    ...
    if (!selfClosing && !voidElementNames__default.test(element.e)) {
      ...
      while (element__canContain(lowerCaseName, parser.remaining()) && (child = parser.read(element__converters))) {
        ...
        if (child.t === types__default.CLOSING_TAG) {
          break;
  ...
  function stripStandalones__isComment(item) {
    return item.t === types__default.COMMENT || item.t === types__default.DELIMCHANGE;
  }
  
  function stripStandalones__isSection(item) {
    return (item.t === types__default.SECTION || item.t === types__default.INVERTED) && item.f;
  }
  ...
  function processPartials__process(path, target, items) {
    ...
    while (i--) {
      ...
      if (processPartials__isPartial(item)) {
        ...
        items.splice(i, 1);
      } else if (isArray__default(item.f)) {
  ...
  function processPartials__isPartial(item) {
    return item.t === types__default.INLINE_PARTIAL;
  }
  ...
  var isEmptyObject__default = function (obj) {
    // if it's not an object, it's not an empty object
    if (!isObject__default(obj)) {
      return false;
    }
  ...
  //# sourceMappingURL=01-_6to5-isEmptyObject.js.map
  ...
  parse__parse = function (template, options) {
    ...
    if (!isEmptyObject__default(partials)) {
      result.p = partials;
    }
  ...
  function parse__cleanup(items, stripComments, preserveWhitespace, removeLeadingWhitespace, removeTrailingWhitespace, rewriteElse) {
    ...
    while (i--) {
      ...
      else if (stripComments && item.t === types__default.COMMENT) {
        items.splice(i, 1);
      }
    }
    ...
    while (i--) {
      ...
      // Recurse
      if (item.f) {
        preserveWhitespaceInsideFragment = preserveWhitespace || (item.t === types__default.ELEMENT && parse__preserveWhitespaceElements.test(item.e));
      ...
      if (item.l) {
        ...
        if (rewriteElse) {
          unlessBlock = {
            t: 4,
            n: types__default.SECTION_UNLESS,
            f: item.l
          };
  ...
  function parser__createHelper(parseOptions) {
    var helper = create__default(parser__parser);
  ...
  Registry__Registry.prototype = {
    ...
    configure: function (Parent, target, options) {
      ...
      registry = create__default(Parent[name]);
  ...
  function deprecate__deprecateAdaptors(options) {
    ...
    if (isArray__default(options.adaptors)) {
  ...
  var interpolators__interpolators = {
    number: function (from, to) {
      ...
      if (!isNumeric__default(from) || !isNumeric__default(to)) {
        return null;
      }
    ...
    array: function (from, to) {
      ...
      if (!isArray__default(from) || !isArray__default(to)) {
        return null;
      }
    ...
    object: function (from, to) {
      ...
      if (!isObject__default(from) || !isObject__default(to)) {
        return null;
      }
      ...
      for (prop in from) {
        if (utils_hasOwnProperty__default.call(from, prop)) {
          if (utils_hasOwnProperty__default.call(to, prop)) {
      ...
      for (prop in to) {
        if (utils_hasOwnProperty__default.call(to, prop) && !utils_hasOwnProperty__default.call(from, prop)) {
  ...
  if (typeof document === "undefined") {
    ...
    svg__svg = document && document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1");
  }
  
  var svg__default = svg__svg;
  //# sourceMappingURL=01-_6to5-svg.js.map

	"use strict";
	
	/* global console */
	var hasConsole__default = (typeof console !== "undefined" && typeof console.warn === "function" && typeof console.warn.apply === "function");
	//# sourceMappingURL=01-_6to5-hasConsole.js.map
  ...
  var removeFromArray__default = function (array, member) {
  ...
  //# sourceMappingURL=01-_6to5-removeFromArray.js.map
  ...
  var normaliseRef__regex = /\[\s*(\*|[0-9]|[1-9][0-9]+)\s*\]/g;
  
  function normaliseRef__normaliseRef(ref) {
    return (ref || "").replace(normaliseRef__regex, ".$1");
  };
  var normaliseRef__default = normaliseRef__normaliseRef;
  //# sourceMappingURL=01-_6to5-normaliseRef.js.map
  ...
  function resolveAncestorRef__resolveAncestorRef(baseContext, ref) {
    var contextKeys;
  ...
  var resolveAncestorRef__default = resolveAncestorRef__resolveAncestorRef;
  //# sourceMappingURL=01-_6to5-resolveAncestorRef.js.map

  "use strict";
  
  function resolveRef__resolveRef(ractive, ref, fragment) {
    ref = normaliseRef__default(ref);
    ...
    if (ref[0] === ".") {
      ref = resolveAncestorRef__default(getInnerContext__default(fragment), ref);
  ...
  TransitionManager__TransitionManager.prototype = {
    ...
    remove: function (transition) {
      var list = transition.isIntro ? this.intros : this.outros;
      removeFromArray__default(list, transition);
      TransitionManager__check(this);
    },
  ...
  runloop__runloop = {
    ...
    removeUnresolved: function (thing) {
      removeFromArray__default(runloop__unresolved, thing);
    },
  ...
  try {
    ...
    magicAdaptor__magicAdaptor = {
      filter: function (object, keypath, ractive) {
        ...
        if (isArray__default(parentValue) && /^[0-9]+$/.test(key)) {
          return false;
        }
  ...
  var createElement__createElement;
  
  // Test for SVG support
  if (!svg__default) {
    createElement__createElement = function (type, ns) {
  ...
  var createElement__default = createElement__createElement;
  //# sourceMappingURL=01-_6to5-createElement.js.map

  "use strict";
  
  var defineProperty__defineProperty;
  ...
  try {
    ...
    defineProperty__defineProperty = Object.defineProperty;
  } catch (err) {
    // Object.defineProperty doesn't exist, or we're in IE8 where you can
    // only use it with DOM objects (what the fuck were you smoking, MSFT?)
    defineProperty__defineProperty = function (obj, prop, desc) {
      obj[prop] = desc.value;
    };
  }
  
  var defineProperty__default = defineProperty__defineProperty;
  //# sourceMappingURL=01-_6to5-defineProperty.js.map

  "use strict";
  
  var defineProperties__defineProperties;
  ...
  try {
    ...
    if (isClient__default) {
      Object.defineProperties(createElement__default("div"), { test: { value: 0 } });
    }
  
    defineProperties__defineProperties = Object.defineProperties;
  } catch (err) {
    defineProperties__defineProperties = function (obj, props) {
      var prop;
  
      for (prop in props) {
        if (props.hasOwnProperty(prop)) {
          defineProperty__default(obj, prop, props[prop]);
        }
      }
    };
  }
  
  var defineProperties__default = defineProperties__defineProperties;
  //# sourceMappingURL=01-_6to5-defineProperties.js.map
  ...
  function add__add(root, keypath, d) {
    ...
    if (typeof keypath !== "string" || !isNumeric__default(d)) {
      throw new Error("Bad arguments");
    }
  
    value = +root.get(keypath) || 0;
  
    if (!isNumeric__default(value)) {
  ...
  var isEqual__default = function (a, b) {
    if (a === null && b === null) {
      return true;
    }
  ...
  //# sourceMappingURL=01-_6to5-isEqual.js.map

  "use strict";
  
  var normaliseKeypath__leadingDot = /^\.+/;
  
  function normaliseKeypath__normaliseKeypath(keypath) {
    return normaliseRef__default(keypath).replace(normaliseKeypath__leadingDot, "");
  };
  var normaliseKeypath__default = normaliseKeypath__normaliseKeypath;
  //# sourceMappingURL=01-_6to5-normaliseKeypath.js.map
  ...
  function animate__animate(root, keypath, to, options) {
    ...
    if (keypath) {
      keypath = normaliseKeypath__default(keypath);
    }
  ...
  function prototype_detach__Ractive$detach() {
    ...
    if (this.el) {
      removeFromArray__default(this.el.__ractive_instances__, this);
    }
  ...
  var matches__matches, matches__div, matches__methodNames, matches__unprefixed, matches__prefixed, matches__i, matches__j, matches__makeFunction;
  
  if (!isClient__default) {
    matches__matches = null;
  } else {
    matches__div = createElement__default("div");
    matches__methodNames = ["matches", "matchesSelector"];
  
    matches__makeFunction = function (methodName) {
      return function (node, selector) {
        return node[methodName](selector);
      };
    };
  
    matches__i = matches__methodNames.length;
  
    while (matches__i-- && !matches__matches) {
      matches__unprefixed = matches__methodNames[matches__i];
  
      if (matches__div[matches__unprefixed]) {
        matches__matches = matches__makeFunction(matches__unprefixed);
      } else {
        matches__j = vendors__default.length;
        while (matches__j--) {
          matches__prefixed = vendors__default[matches__i] + matches__unprefixed.substr(0, 1).toUpperCase() + matches__unprefixed.substring(1);
  
          if (matches__div[matches__prefixed]) {
            matches__matches = matches__makeFunction(matches__prefixed);
            break;
          }
        }
      }
    ...
    // IE8...
    if (!matches__matches) {
      matches__matches = function (node, selector) {
        ...
        if (!parentNode) {
          // empty dummy <div>
          matches__div.innerHTML = "";
  
          parentNode = matches__div;
          node = node.cloneNode();
  
          matches__div.appendChild(node);
        }
  ...
  var matches__default = matches__matches;
  //# sourceMappingURL=01-_6to5-matches.js.map
  ...
  var test__default = function (item, noDirty) {
    ...
    if (this._isComponentQuery) {
      ...
      itemMatches = item.node ? matches__default(item.node, this.selector) : null;
    }
  ...
  function makeQuery__makeQuery(ractive, selector, live, isComponentQuery) {
    ...
    defineProperties__default(query, {
  ...
  function getElement__getElement(input) {
    var output;
  ...
  var getElement__default = getElement__getElement;
  //# sourceMappingURL=01-_6to5-getElement.js.map
  ...
  function insert__Ractive$insert(target, anchor) {
    ...
    target = getElement__default(target);
    anchor = getElement__default(anchor) || null;
  ...
  function prototype_merge__Ractive$merge(keypath, array, options) {
    ...
    if (!isArray__default(currentArray) || !isArray__default(array)) {
  ...
  Observer__Observer.prototype = {
    ...
    setValue: function (value) {
      var _this = this;
      if (!isEqual__default(value, this.value)) {
        this.value = value;
  ...
  function getMatchingKeypaths__getMatchingKeypaths(ractive, pattern) {
    ...
    function expand(matchingKeypaths, keypath) {
      ...
      for (key in value) {
        if (value.hasOwnProperty(key) && (key !== "_ractive" || !isArray__default(value))) {
          // for benefit of IE8
  ...
  var getMatchingKeypaths__default = getMatchingKeypaths__getMatchingKeypaths;
  //# sourceMappingURL=01-_6to5-getMatching.js.map
  ...
  function getPattern__getPattern(ractive, pattern) {
    ...
    matchingKeypaths = getMatchingKeypaths__default(ractive, pattern);
  ...
  PatternObserver__PatternObserver.prototype = {
    ...
    reallyUpdate: function (keypath) {
      ...
      if (!isEqual__default(value, this.values[keypath]) || !this.ready) {
  ...
  if (!isClient__default) {
    ...
    global_css__css = {
      ...
      remove: function (Component) {
        ...
        if (!global_css__componentsInPage[Component._guid]) {
          removeFromArray__default(global_css__styles, Component.css);
  ...
  function prototype_render__Ractive$render(target, anchor) {
    ...
    target = getElement__default(target) || this.el;
    anchor = getElement__default(anchor) || this.anchor;
  ...
  var escapeHtml__lessThan = /</g;
  var escapeHtml__greaterThan = />/g;
  var escapeHtml__amp = /&/g;
  
  function escapeHtml__escapeHtml(str) {
    return str.replace(escapeHtml__amp, "&amp;").replace(escapeHtml__lessThan, "&lt;").replace(escapeHtml__greaterThan, "&gt;");
  };
  var escapeHtml__default = escapeHtml__escapeHtml;
  //# sourceMappingURL=01-_6to5-escapeHtml.js.map

  "use strict";
  
  function detachNode__detachNode(node) {
  ...
  var detachNode__default = detachNode__detachNode;
  //# sourceMappingURL=01-_6to5-detachNode.js.map

  "use strict";
  
  var detach__default = function () {
    return detachNode__default(this.node);
  };
  //# sourceMappingURL=01-_6to5-detach.js.map
  ...
  Text__Text.prototype = {
    ...
    toString: function (escape) {
      return escape ? escapeHtml__default(this.text) : this.text;
    },
  ...
  function startsWithKeypath__startsWithKeypath(target, keypath) {
    return target && keypath && target.substr(0, keypath.length + 1) === keypath + ".";
  };
  var startsWithKeypath__default = startsWithKeypath__startsWithKeypath;
  //# sourceMappingURL=01-_6to5-startsWith.js.map

  "use strict";
  
  function getNewKeypath__getNewKeypath(targetKeypath, oldKeypath, newKeypath) {
    // exact match
    ...
    if (startsWithKeypath__default(targetKeypath, oldKeypath)) {
      return newKeypath === null ? newKeypath : targetKeypath.replace(oldKeypath + ".", newKeypath + ".");
    }
  };
  var getNewKeypath__default = getNewKeypath__getNewKeypath;
  //# sourceMappingURL=01-_6to5-getNew.js.map
  ...
  ReferenceResolver__ReferenceResolver.prototype = {
    ...
    rebind: function (oldKeypath, newKeypath) {
      ...
      if (this.keypath !== undefined) {
        keypath = getNewKeypath__default(this.keypath, oldKeypath, newKeypath);
  ...
  SpecialResolver__SpecialResolver.prototype = {
    rebind: function () {
      ...
      if (prop.prop.indexOf("index") !== -1 || prop.prop.indexOf("key") !== -1) {
        while (fragment) {
          if (fragment.owner.currentSubtype === types__default.SECTION_EACH && (value = SpecialResolver__getProp(fragment, prop)) !== undefined) {
  ...
  function decodeKeypath__decodeKeypath(keypath) {
    var value = keypath.slice(2);
  
    if (keypath[1] === "i") {
      return isNumeric__default(value) ? +value : value;
    } else {
      return value;
    }
  };
  var decodeKeypath__default = decodeKeypath__decodeKeypath;
  //# sourceMappingURL=01-_6to5-decode.js.map
    ...
    createEvaluator: function () {
      ...
      if (!computation) {
        ...
        valueGetters = this.keypaths.map(function (keypath) {
          ...
          if (keypath[0] === "@") {
            value = decodeKeypath__default(keypath);
            return function () {
              return value;
            };
          }
  ...
  function ExpressionResolver__wrapFunction(fn, ractive) {
    ...
    if (wrapped) {
      ...
      defineProperty__default(fn, prop, {
    ...
    defineProperty__default(fn, "__ractive_nowrap", {
      value: fn
    });
  ...
  var MemberResolver__MemberResolver = function (template, resolver, parentFragment) {
    ...
    // Simple reference?
    else if (template.t === types__default.REFERENCE) {
  ...
  ReferenceExpressionResolver__ReferenceExpressionResolver.prototype = {
    ...
    unbind: function () {
      this.members.forEach(ReferenceExpressionResolver__unbind);
    },
  ...
  function ReferenceExpressionResolver__unbind(member) {
    member.unbind();
  }
  ...
  function init__Mustache$init(mustache, options) {
    ...
    if (mustache.template.n === types__default.SECTION_UNLESS && !mustache.hasOwnProperty("value")) {
  ...
  function resolve__Mustache$resolve(keypath) {
    ...
    if (keypath && keypath[0] === "@") {
      this.keypath = keypath;
      this.setValue(decodeKeypath__default(keypath));
      return;
    }
  ...
  var Interpolator__Interpolator = function (options) {
    this.type = types__default.INTERPOLATOR;
  ...
  Interpolator__Interpolator.prototype = {
    ...
    toString: function (escape) {
      ...
      return escape ? escapeHtml__default(string) : string;
    }
  };
  ...
  function shuffle__Section$shuffle(newIndices) {
    ...
    // non-list sections
    if (this.shuffling || this.unbound || (this.currentSubtype !== types__default.SECTION_EACH)) {
      return;
    }
  ...
  var isArrayLike__pattern = /^\[object (?:Array|FileList)\]$/, isArrayLike__toString = Object.prototype.toString;
  
  function isArrayLike__isArrayLike(obj) {
    return isArrayLike__pattern.test(isArrayLike__toString.call(obj));
  };
  var isArrayLike__default = isArrayLike__isArrayLike;
  //# sourceMappingURL=01-_6to5-isArrayLike.js.map
  ...
  function setValue__changeCurrentSubtype(section, value, obj) {
    if (value === types__default.SECTION_EACH) {
  ...
  function setValue__reevaluateSection(section, value) {
    ...
    section.ordered = !!isArrayLike__default(value);
  
    // Ordered list section
    if (section.ordered) {
      setValue__changeCurrentSubtype(section, types__default.SECTION_EACH, false);
      return setValue__reevaluateListSection(section, value, fragmentOptions);
    }
  
    // Unordered list, or context
    if (isObject__default(value) || typeof value === "function") {
      // Index reference indicates section should be treated as a list
      if (section.template.i) {
        setValue__changeCurrentSubtype(section, types__default.SECTION_EACH, true);
        return setValue__reevaluateListObjectSection(section, value, fragmentOptions);
      }
  
      // Otherwise, object provides context for contents
      setValue__changeCurrentSubtype(section, types__default.SECTION_WITH, false);
      return setValue__reevaluateContextSection(section, fragmentOptions);
    }
  
    // Conditional section
    setValue__changeCurrentSubtype(section, types__default.SECTION_IF, false);
    return setValue__reevaluateConditionalSection(section, value, false, fragmentOptions);
  }
  ...
  function setValue__reevaluateListSection(section, value, fragmentOptions) {
    ...
    if (length < section.length) {
      ...
      section.fragmentsToUnrender.forEach(setValue__unbind);
    }
  ...
  function setValue__reevaluateConditionalSection(section, value, inverted, fragmentOptions) {
    ...
    emptyArray = (isArrayLike__default(value) && value.length === 0);
    emptyObject = false;
    if (!isArrayLike__default(value) && isObject__default(value)) {
      emptyObject = true;
      for (name in value) {
        emptyObject = false;
        break;
  ...
  function setValue__unbind(fragment) {
    fragment.unbind();
  }
  ...
  function prototype_unbind__Section$unbind() {
    var _this = this;
    this.fragments.forEach(prototype_unbind__unbindFragment);
    this.fragmentsToRender.forEach(function (f) {
      return removeFromArray__default(_this.fragments, f);
    });
    this.fragmentsToRender = [];
  ...
  function prototype_unbind__unbindFragment(fragment) {
    fragment.unbind();
  }
  //# sourceMappingURL=01-_6to5-unbind.js.map
  ...
  var Section__Section = function (options) {
    this.type = types__default.SECTION;
    this.subtype = this.currentSubtype = options.template.n;
    this.inverted = this.subtype === types__default.SECTION_UNLESS;
  ...
  function Triple_prototype_find__Triple$find(selector) {
    ...
    for (i = 0; i < len; i += 1) {
      ...
      if (matches__default(node, selector)) {
        return node;
      }
  ...
  try {
    createElement__default("table").innerHTML = "foo";
  } catch (err) {
  ...
  function insertHtml__element(tagName) {
    return insertHtml__elementCache[tagName] || (insertHtml__elementCache[tagName] = createElement__default(tagName));
  }
  //# sourceMappingURL=01-_6to5-insertHtml.js.map

  "use strict";
  
  function toArray__toArray(arrayLike) {
  ...
  var toArray__default = toArray__toArray;
  //# sourceMappingURL=01-_6to5-toArray.js.map
  ...
  function updateSelect__updateSelect(parentElement) {
    ...
    selectedOptions = toArray__default(parentElement.node.options).filter(updateSelect__isSelected);
  ...
  function Triple_prototype_toString__Triple$toString() {
    return (this.value != undefined ? decodeCharacterReferences__default("" + this.value) : "");
  };
  ...
  function prototype_unrender__Triple$unrender(shouldDestroy) {
    if (this.rendered && shouldDestroy) {
      this.nodes.forEach(detachNode__default);
      this.rendered = false;
    }
  ...
  var Triple__Triple = function (options) {
    this.type = types__default.TRIPLE;
    Mustache__default.init(this, options);
  };
  ...
  var Element_prototype_find__default = function (selector) {
    ...
    if (matches__default(this.node, selector)) {
      return this.node;
    }
  ...
  //# sourceMappingURL=01-_6to5-bubble.js.map
	...
	var booleanAttributes__booleanAttributes = /^(allowFullscreen|async|autofocus|autoplay|checked|compact|controls|declare|default|defaultChecked|defaultMuted|defaultSelected|defer|disabled|draggable|enabled|formNoValidate|hidden|indeterminate|inert|isMap|itemScope|loop|multiple|muted|noHref|noResize|noShade|noValidate|noWrap|open|pauseOnExit|readOnly|required|reversed|scoped|seamless|selected|sortable|translate|trueSpeed|typeMustMatch|visible)$/i;
	var booleanAttributes__default = booleanAttributes__booleanAttributes;
	//# sourceMappingURL=01-_6to5-booleanAttributes.js.map
  ...
  function getInterpolator__getInterpolator(attribute) {
    ...
    if (items[0].type === types__default.INTERPOLATOR) {
      return items[0];
    }
  };
  ...
  var determinePropertyName__default = function (attribute, options) {
    ...
    if (attribute.pNode && !attribute.namespace && (!options.pNode.namespaceURI || options.pNode.namespaceURI === namespaces__default.html)) {
      ...
      if (booleanAttributes__default.test(propertyName) || propertyName === "value") {
  ...
  function prototype_init__Attribute$init(options) {
    this.type = types__default.ATTRIBUTE;
    ...
    if (!options.value || typeof options.value === "string") {
      this.value = booleanAttributes__default.test(this.name) ? true : options.value || "";
  ...
  function Attribute_prototype_toString__Attribute$toString() {
    ...
    // Boolean attributes
    if (booleanAttributes__default.test(name)) {
      return value ? name : "";
    }
  ...
  function arrayContains__arrayContains(array, value) {
  ...
  var arrayContains__default = arrayContains__arrayContains;
  //# sourceMappingURL=01-_6to5-arrayContains.js.map
  ...
  function updateMultipleSelectValue__Attribute$updateMultipleSelect() {
    ...
    while (i--) {
      option = options[i];
      optionValue = option._ractive ? option._ractive.value : option.value; // options inserted via a triple don't have _ractive
      option.selected = arrayContains__default(value, optionValue);
    }
  };
  ...
  function updateEverythingElse__Attribute$updateEverythingElse() {
    ...
    } else if (!booleanAttributes__default.test(name)) {
  ...
  if (typeof document !== "undefined") {
    ConditionalAttribute__div = createElement__default("div");
  }
  ...
  function ConditionalAttribute__parseAttributes(str, isSvg) {
    ...
    return toArray__default(ConditionalAttribute__div.childNodes[0].attributes);
  }
  ...
  var extend___slice = Array.prototype.slice;
  var extend__default = function (target) {
    var sources = extend___slice.call(arguments, 1);
  ...
  //# sourceMappingURL=01-_6to5-extend.js.map
  ...
  Binding__Binding.prototype = {
    ...
    rebound: function () {
      ...
      removeFromArray__default(this.root._twowayBindings[oldKeypath], this);
  ...
  Binding__Binding.extend = function (properties) {
    ...
    SpecialisedBinding.prototype = create__default(Parent.prototype);
    extend__default(SpecialisedBinding.prototype, properties);
  ...
  var RadioBinding__RadioBinding = Binding__default.extend({
    ...
    unbind: function () {
      removeFromArray__default(this.siblings, this);
    }
  });
  ...
  var CheckboxNameBinding__CheckboxNameBinding = Binding__default.extend({
    ...
    render: function () {
      ...
      if (isArray__default(existingValue)) {
        this.isChecked = arrayContains__default(existingValue, bindingValue);
      } else {
  ...
  var arrayContentsMatch__default = function (a, b) {
    var i;
  
    if (!isArray__default(a) || !isArray__default(b)) {
      return false;
    }
  ...
  //# sourceMappingURL=01-_6to5-arrayContentsMatch.js.map
  ...
  var MultipleSelectBinding__MultipleSelectBinding = SelectBinding__default.extend({
    ...
    handleChange: function () {
      ...
      if (previousValue === undefined || !arrayContentsMatch__default(value, previousValue)) {
  ...
  var isNumber__toString = Object.prototype.toString;
  
  var isNumber__default = function (thing) {
    return (typeof thing === "number" || (typeof thing === "object" && isNumber__toString.call(thing) === "[object Number]"));
  };
  //# sourceMappingURL=01-_6to5-isNumber.js.map
  ...
  GenericBinding__GenericBinding = Binding__default.extend({
    ...
    render: function () {
      ...
      if (this.element.lazy === true) {
        ...
        lazy = false;
      } else if (isNumber__default(this.element.lazy)) {
        lazy = false;
  ...
  function EventHandler_prototype_unbind__EventHandler$unbind() {
    if (this.method) {
      this.refResolvers.forEach(EventHandler_prototype_unbind__unbind);
      return;
    }
  ...
  function EventHandler_prototype_unbind__unbind(x) {
    x.unbind();
  }
  //# sourceMappingURL=01-_6to5-unbind.js.map
  ...
  function syncSelect__syncSelect(selectElement) {
    ...
    options = toArray__default(selectNode.options);
  ...
  function Element_prototype_init__Element$init(options) {
    ...
    this.type = types__default.ELEMENT;
  ...
  function equalsOrStartsWith__equalsOrStartsWith(target, keypath) {
    return target === keypath || startsWithKeypath__default(target, keypath);
  };
  var equalsOrStartsWith__default = equalsOrStartsWith__equalsOrStartsWith;
  //# sourceMappingURL=01-_6to5-equalsOrStartsWith.js.map

  "use strict";
  
  function assignNewKeypath__assignNewKeypath(target, property, oldKeypath, newKeypath) {
    var existingKeypath = target[property];
  
    if (!existingKeypath || equalsOrStartsWith__default(existingKeypath, newKeypath) || !equalsOrStartsWith__default(existingKeypath, oldKeypath)) {
      return;
    }
  
    target[property] = getNewKeypath__default(existingKeypath, oldKeypath, newKeypath);
    return true;
  };
  var assignNewKeypath__default = assignNewKeypath__assignNewKeypath;
  //# sourceMappingURL=01-_6to5-assignNew.js.map
  ...
  function Element_prototype_rebind__Element$rebind(oldKeypath, newKeypath) {
    ...
    if (this.node && (storage = this.node._ractive)) {
      ...
      assignNewKeypath__default(storage, "keypath", oldKeypath, newKeypath);
    }
  ...
  if (!isClient__default) {
    ...
    prefix__prefixCache = {};
    prefix__testStyle = createElement__default("div").style;
  ...
  if (!isClient__default) {
    ...
    createTransitions__testStyle = createElement__default("div").style;
  ...
  var fillGaps___slice = Array.prototype.slice;
  var fillGaps__default = function (target) {
    var sources = fillGaps___slice.call(arguments, 1);
  ...
  //# sourceMappingURL=01-_6to5-fillGaps.js.map
  ...
  var processParams__default = function (params, defaults) {
    ...
    return fillGaps__default({}, params, defaults);
  };
  ...
  function Element_prototype_render__Element$render() {
    ...
    node = this.node = createElement__default(this.name, namespace);
    ...
    defineProperty__default(this.node, "_ractive", {
      value: {
        proxy: this,
        keypath: getInnerContext__default(this.parentFragment),
        events: create__default(null),
        root: root
      }
    });
  ...
  function Element_prototype_render__processOption(option) {
    ...
    if (option.select.node.multiple && isArray__default(selectValue)) {
  ...
  var Element_prototype_toString__default = function () {
    ...
    if (this.name === "textarea" && this.getAttribute("value") !== undefined) {
      str += escapeHtml__default(this.getAttribute("value"));
    }
    ...
    if (!voidElementNames__default.test(this.template.e)) {
      str += "</" + this.template.e + ">";
    }
  ...
  function Element_prototype_toString__optionIsSelected(element) {
    ...
    if (element.select.getAttribute("multiple") && isArray__default(selectValue)) {
      i = selectValue.length;
      while (i--) {
        if (selectValue[i] == optionValue) {
          return true;
  ...
  function unbindOption__unbindOption(option) {
    if (option.select) {
      removeFromArray__default(option.select.options, option);
    }
  };
  ...
  function Element_prototype_unbind__Element$unbind() {
    ...
    if (this.eventHandlers) {
      this.eventHandlers.forEach(Element_prototype_unbind__unbind);
    }
    ...
    this.attributes.forEach(Element_prototype_unbind__unbind);
    this.conditionalAttributes.forEach(Element_prototype_unbind__unbind);
  };
  var Element_prototype_unbind__default = Element_prototype_unbind__Element$unbind;
  
  function Element_prototype_unbind__unbind(x) {
    x.unbind();
  }
  //# sourceMappingURL=01-_6to5-unbind.js.map
  ...
  var Partial__Partial = function (options) {
    ...
    this.type = types__default.PARTIAL;
    this.index = options.index;
  ...
  Partial__Partial.prototype = {
    ...
    toString: function (toString) {
      ...
      if (!previousItem || (previousItem.type !== types__default.TEXT)) {
        return string;
      }
  ...
  var getNextNumber__i = 0;
  
  var getNextNumber__default = function () {
    return "r-" + getNextNumber__i++;
  };
  //# sourceMappingURL=01-_6to5-getNextNumber.js.map
  ...
  patch__mutatorMethods.forEach(function (methodName) {
    ...
    defineProperty__default(patch__patchedArrayProto, methodName, {
      value: method
    });
  });
  ...
  if (patch__testObj.__proto__) {
    ...
    patch__patchArrayMethods = function (array) {
      ...
      while (i--) {
        ...
        defineProperty__default(array, methodName, {
  ...
  arrayAdaptor__arrayAdaptor = {
    filter: function (object) {
      ...
      return isArray__default(object) && (!object._ractive || !object._ractive.setting);
    },
  ...
  arrayAdaptor__ArrayWrapper = function (ractive, array, keypath) {
    ...
    if (!array._ractive) {
      ...
      defineProperty__default(array, "_ractive", {
        value: {
          wrappers: [],
          instances: [],
          setting: false
        ...
        if (this._firstRun || (!this.hardDeps.length && !this.softDeps.length)) {
          ...
          [this.hardDeps, this.softDeps].forEach(function (deps) {
            ...
            while (i--) {
              ...
              if (!isEqual__default(value, _this2.depValues[keypath])) {
  ...
  function get__Viewmodel$get(keypath, options) {
    ...
    return (function () {
      ...
      if (keypath[0] === "@") {
        return decodeKeypath__default(keypath);
      }
  ...
  var consolewarn__warn, consolewarn__warned = {};
  
  if (hasConsole__default) {
    consolewarn__warn = function (message, allowDuplicates) {
      if (!allowDuplicates) {
        if (consolewarn__warned[message]) {
          return;
        }
  
        consolewarn__warned[message] = true;
      }
  
      console.warn("%cRactive.js: %c" + message, "color: rgb(114, 157, 52);", "color: rgb(85, 85, 85);");
    };
  } else {
    consolewarn__warn = function () {};
  }
  
  var consolewarn__default = consolewarn__warn;
  //# sourceMappingURL=01-_6to5-warn.js.map
  ...
  var utils_log__log = {
    ...
    warnAlways: function (options) {
      this.logger(utils_log__getMessage(options), options.allowDuplicates);
    },
    error: function (options) {
      this.errorOnly(options);
    ...
    critical: function (options) {
      var err = options.err || new Error(utils_log__getMessage(options));
      this.thrower(err);
    },
    logger: consolewarn__default,
    thrower: function (err) {
      throw err;
    }
  };
  
  function utils_log__getMessage(options) {
    var message = config_errors__default[options.message] || options.message || "";
    return utils_log__interpolate(message, options.args);
  }
  
  // simple interpolation. probably quicker (and better) out there,
  // but log is not in golden path of execution, only exceptions
  function utils_log__interpolate(message, args) {
    return message.replace(/{([^{}]*)}/g, function (a, b) {
      return args[b];
    });
  }
  
  var utils_log__default = utils_log__log;
  //# sourceMappingURL=01-_6to5-log.js.map
  ...
  function set__Viewmodel$set(keypath, value, options) {
    ...
    if (isEqual__default(this.cache[keypath], value)) {
      return;
    }
  ...
  function unregister__updateDependantsMap(viewmodel, keypath, group) {
    ...
    while (keys.length) {
      ...
      if (!parent[keypath]) {
        ...
        removeFromArray__default(parent, keypath);
  ...
  var Viewmodel__Viewmodel = function (ractive, mappings) {
    var _this = this;
    if (mappings === undefined) mappings = create__default(null);
    return (function () {
      var key, mapping;
      ...
      _this.cacheMap = create__default(null);
  
      _this.deps = {
        computed: create__default(null),
        "default": create__default(null)
      };
      _this.depsMap = {
        computed: create__default(null),
        "default": create__default(null)
      ...
      _this.specials = create__default(null);
  
      _this.wrapped = create__default(null);
      _this.computations = create__default(null);
  ...
  var initialise__constructHook = new Hook__default("construct"), initialise__configHook = new Hook__default("config"), initialise__initHook = new HookQueue__default("init");
  ...
  function initialise__initialiseRactiveInstance(ractive, userOptions, options) {
    ...
    if (el = getElement__default(ractive.el)) {
  ...
  function initialise__initialiseProperties(ractive, options) {
    ...
    // existed
    ractive._guid = getNextNumber__default();
  
    // events
    ractive._subs = create__default(null);
    ...
    // two-way bindings
    ractive._twowayBindings = create__default(null);
  ...
  var createInstance__default = function (component, Component, parameters, yieldTemplate, partials) {
    ...
    partials = partials || {};
    extend__default(inlinePartials, partials || {});
    ...
    while (fragment) {
      if (fragment.owner.type === types__default.YIELDER) {
    ...
    instance = create__default(Component.prototype);
  ...
  function createComponentData__makeConstructor(parameters, defined) {
    ...
    defineProperties__default(proto = {}, properties);
  ...
  ParameterResolver__ParameterResolver.prototype = {
    ...
    notReadyResolve: function (keypath) {
      if (this.specialRef) {
        this.parameters.addData(this.key, decodeKeypath__default(keypath));
      } else {
  ...
  function createParameters__ComponentParameters(component, attributes, defined) {
    ...
    this.data = {};
    this.mappings = create__default(null);
    this.newKeys = [];
  ...
  function createParameters__isSingleInterpolator(template) {
    return template.length === 1 && template[0].t === types__default.INTERPOLATOR;
  }
  ...
  function Component_prototype_init__Component$init(options, Component) {
    ...
    this.root = root;
    this.type = types__default.COMPONENT;
    ...
    if (options.template.t1 || options.template.t2 || options.template.o) {
      consolewarn__default("The \"intro\", \"outro\" and \"decorator\" directives have no effect on components");
    }
  ...
  function Component_prototype_unbind__Component$unbind() {
    ...
    this.resolvers.forEach(Component_prototype_unbind__unbind);
    ...
    if (instance.fragment.rendered && instance.el.__ractive_instances__) {
      removeFromArray__default(instance.el.__ractive_instances__, instance);
    }
  ...
  function Component_prototype_unbind__unbind(thing) {
    thing.unbind();
  }
  ...
  var Comment__Comment = function (options) {
    this.type = types__default.COMMENT;
  ...
  var Yielder__Yielder = function (options) {
    ...
    this.type = types__default.YIELDER;
    ...
    if (!isArray__default(component.yielders[name])) {
  ...
  Yielder__Yielder.prototype = {
    ...
    unrender: function (shouldDestroy) {
      this.fragment.unrender(shouldDestroy);
      removeFromArray__default(this.component.yielders[this.name], this);
    },
  ...
  function createItem__createItem(options) {
    ...
    switch (options.template.t) {
      case types__default.INTERPOLATOR:
        if (options.template.r === "yield") {
          return new Yielder__default(options);
        }
        return new Interpolator__default(options);
      case types__default.SECTION: return new Section__default(options);
      case types__default.TRIPLE: return new Triple__default(options);
      case types__default.ELEMENT:
        var constructor;
      ...
      case types__default.PARTIAL: return new Partial__default(options);
      case types__default.COMMENT: return new Comment__default(options);
      case types__default.DOCTYPE: return new Doctype__default(options);
  ...
  function Fragment_prototype_rebind__Fragment$rebind(oldKeypath, newKeypath) {
    ...
    assignNewKeypath__default(this, "context", oldKeypath, newKeypath);
  ...
  var resetPartial__default = function (name, partial, callback) {
    ...
    function collect(source, dest, ractive) {
      ...
      source.forEach(function (item) {
        ...
        if (item.type === types__default.PARTIAL && item.getPartialName() === name) {
          dest.push(item);
        }
        ...
        if (isArray__default(item.fragments)) {
          collect(item.fragments, dest, ractive);
        }
  
        // or if it is itself a fragment, process its items
        else if (isArray__default(item.items)) {
          collect(item.items, dest, ractive);
        }
  
        // or if it is a component, step in and process its items
        else if (item.type === types__default.COMPONENT && item.instance) {
          collect(item.instance.fragment.items, dest, item.instance);
        }
  
        // if the item is an element, process its attributes too
        if (item.type === types__default.ELEMENT) {
          if (isArray__default(item.attributes)) {
            collect(item.attributes, dest, ractive);
          }
  
          if (isArray__default(item.conditionalAttributes)) {
  ...
  function prototype_set__Ractive$set(keypath, value, callback) {
    ...
    // Set a single keypath
      ...
      if (prototype_set__wildcard.test(keypath)) {
        getMatchingKeypaths__default(this, keypath).forEach(function (keypath) {
  ...
  function updateModel__Ractive$updateModel(keypath, cascade) {
    ...
    if (typeof keypath === "string" && !cascade) {
      ...
      for (key in this._twowayBindings) {
        if (!keypath || equalsOrStartsWith__default(key, keypath)) {
  ...
  function updateModel__consolidate(ractive, bindings) {
    ...
    bindings.forEach(function (b) {
      ...
      if (arrayContentsMatch__default(oldValue, newValue)) {
        return;
      }
  
      if (!isEqual__default(oldValue, newValue)) {
  ...
  function _extend__extend(options) {
    if (options === undefined) options = {};
    ...
    proto = create__default(Parent.prototype);
    proto.constructor = Child;
  
    staticProperties = {
      // each component needs a unique ID, for managing CSS
      _guid: { value: _extend__uid++ },
    ...
    defineProperties__default(Child, staticProperties);
  ...
  var _extend__default = _extend__extend;
  ...
  // Ractive properties
  defineProperties__default(Ractive__Ractive, Ractive__properties);
  
  Ractive__Ractive.prototype = extend__default(proto__default, defaults__default);
