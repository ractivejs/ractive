...
(function (global, factory) {
  ...
  var environment__magic = undefined;
  try {
  ...
  var environment__svg = doc ? doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1') : false;

  var vendors = ['o', 'ms', 'moz', 'webkit'];

  var html = 'http://www.w3.org/1999/xhtml';
  var mathml = 'http://www.w3.org/1998/Math/MathML';
  var namespaces__svg = 'http://www.w3.org/2000/svg';
  	...
  	if (/\*/.test(keypath)) {
  		var _ret = (function () {
  			...
  			ractive.viewmodel.findMatches(splitKeypath(keypath)).forEach(function (model) {
  				...
  				if (!isNumeric(value)) throw new Error(shared_add__errorMessage);
  ...
  function Hook___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Hook = (function () {
  	function Hook(event) {
  		Hook___classCallCheck(this, Hook);
  ...
  function methodCallers__bind(x) {
    x.bind();
  }
  ...
  function methodCallers__handleChange(x) {
    x.handleChange();
  }

  function methodCallers__mark(x) {
    x.mark();
  }

  function methodCallers__render(x) {
    x.render();
  }

  function methodCallers__rebind(x) {
    x.rebind();
  }
  ...
  function methodCallers__unrenderAndDestroy(x) {
    x.unrender(true);
  }

  function methodCallers__update(x) {
    x.update();
  }

  function methodCallers__toString(x) {
    return x.toString();
  }
  ...
  function TransitionManager___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var TransitionManager = (function () {
  	function TransitionManager(callback, parent) {
  		TransitionManager___classCallCheck(this, TransitionManager);
  ...
  function animate(root, keypath, to, options) {
  	...
  	if (keypath) {
  		...
  		shared_animations.abort(model, root);
  	}
  ...
  function Query___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Query = (function () {
  	function Query(ractive, selector, live, isComponentQuery) {
  		Query___classCallCheck(this, Query);
  ...
  function observe___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Observer = (function () {
  	function Observer(context, model, callback, options) {
  		observe___classCallCheck(this, Observer);
  ...
  var PatternObserver = (function () {
  	function PatternObserver(context, baseModel, keys, callback, options) {
  		...
  		observe___classCallCheck(this, PatternObserver);
  ...
  function observeList___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var ListObserver = (function () {
  	function ListObserver(context, model, callback, options) {
  		observeList___classCallCheck(this, ListObserver);
  ...
  function observeOnce(keypath, callback, options) {
  	if (isObject(keypath) || typeof keypath === 'function') {
  		options = utils_object__extend(callback || {}, onceOptions);
  		return this.observe(keypath, options);
  	}

  	options = utils_object__extend(options || {}, onceOptions);
  ...
  var prototype_push = makeArrayMethod('push');
  ...
  var _render = _render__render;
  var _render__renderHook = new Hook('render');
  var _render__completeHook = new Hook('complete');
  function _render__render(ractive, target, anchor) {
  	...
  	runloop.scheduleTask(function () {
  		return _render__renderHook.fire(ractive);
  	}, true);
  	...
  	if (ractive.cssId) global_css.apply();
  	...
  	return promise.then(function () {
  		return _render__completeHook.fire(ractive);
  	});
  }
  ...
  function removeOtherInstances(others) {
  	others.splice(0, others.length).forEach(methodCallers__teardown);
  }
  ...
  var cleanup__leadingWhitespace = /^[ \t\f\r\n]+/;
  ...
  function cleanup(items, stripComments, preserveWhitespace, removeLeadingWhitespace, removeTrailingWhitespace) {
  	...
  	trimWhitespace(items, removeLeadingWhitespace ? cleanup__leadingWhitespace : null, removeTrailingWhitespace ? trailingWhitespace : null);
  ...
  function getDynamicTemplate(ractive, fn) {
  	var helper = templateConfigurator__createHelper(template_parser.getParseOptions(ractive));
  ...
  var prototype_reset__completeHook = new Hook('complete');
  var resetHook = new Hook('reset');
  var prototype_reset__renderHook = new Hook('render');
  var prototype_reset__unrenderHook = new Hook('unrender');
  function Ractive$reset(data) {
  	...
  	if (rerender) {
  		prototype_reset__unrenderHook.fire(this);
  		this.fragment.resetTemplate(this.template);
  		prototype_reset__renderHook.fire(this);
  		prototype_reset__completeHook.fire(this);
  	}
  ...
  function shared_Item___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

  var Item = (function () {
  	function Item(options) {
  		shared_Item___classCallCheck(this, Item);
  ...
  function arrayAdaptor___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var arrayAdaptor__errorMessage = 'Something went wrong in a rather interesting way';
  ...
  var ArrayWrapper = (function () {
  	function ArrayWrapper(ractive, array) {
  		arrayAdaptor___classCallCheck(this, ArrayWrapper);
  ...
  function magicAdaptor___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var MagicWrapper = (function () {
  	function MagicWrapper(ractive, value, keypath) {
  		...
  		magicAdaptor___classCallCheck(this, MagicWrapper);
  ...
  function KeyModel___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var KeyModel = (function () {
  	function KeyModel(key) {
  		KeyModel___classCallCheck(this, KeyModel);
  	...
  	KeyModel.prototype.rebind = function rebind(key) {
  		this.value = key;
  		this.dependants.forEach(methodCallers__handleChange);
  	};
  ...
  function KeypathModel___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var KeypathModel = (function () {
  	function KeypathModel(parent) {
  		KeypathModel___classCallCheck(this, KeypathModel);
  ...
  function Model___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Model = (function () {
  	function Model(parent, key) {
  		Model___classCallCheck(this, Model);
  	...
  	Model.prototype.mark = function mark() {
  		...
  		if (!isEqual(value, this.value)) {
  			...
  			this.children.forEach(methodCallers__mark);

  			this.deps.forEach(methodCallers__handleChange);
  	...
  	Model.prototype.set = function set(value) {
  		...
  		while (parent) {
  			parent.deps.forEach(methodCallers__handleChange);
  	...
  	Model.prototype.teardown = function teardown() {
  		this.children.forEach(methodCallers__teardown);
  ...
  function Computation___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Computation___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var Computation = (function (_Model) {
  	Computation___inherits(Computation, _Model);

  	function Computation(viewmodel, signature, key) {
  		Computation___classCallCheck(this, Computation);
  	...
  	Computation.prototype.handleChange = function handleChange() {
  		...
  		this.deps.forEach(methodCallers__handleChange);
  		this.children.forEach(methodCallers__mark); // TODO rename to mark once bundling glitch fixed
  ...
  function RootModel___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function RootModel___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var RootModel = (function (_Model) {
  	RootModel___inherits(RootModel, _Model);

  	function RootModel(options) {
  		RootModel___classCallCheck(this, RootModel);
  	...
  	RootModel.prototype.get = function get(shouldCapture) {
  		...
  		if (shouldCapture) capture(this);
  		var result = utils_object__extend({}, this.value);
  ...
  function createFunctionFromString(ractive, str) {
  	...
  	functionBody = 'return (' + str.replace(getComputationSignature__pattern, function (match, keypath) {
  		hasThis = true;
  ...
  function getComputationSignature__bind(fn, context) {
  ...
  function getComputationSignature(ractive, key, signature) {
  	...
  	if (typeof signature === 'function') {
  		getter = getComputationSignature__bind(signature, ractive);
  	...
  	if (typeof signature === 'object') {
  		if (typeof signature.get === 'string') {
  			...
  			getter = getComputationSignature__bind(signature.get, ractive);
  		...
  		if (typeof signature.set === 'function') {
  			setter = getComputationSignature__bind(signature.set, ractive);
  ...
  var construct__registryNames = ['adaptors', 'components', 'decorators', 'easing', 'events', 'interpolators', 'partials', 'transitions'];

  var construct__uid = 0;
  function construct(ractive, options) {
  	...
  	// Add registries
  	construct__registryNames.forEach(function (name) {
  		ractive[name] = utils_object__extend(create(ractive.constructor[name] || null), options[name]);
  	});
  	...
  	var computed = utils_object__extend(create(ractive.constructor.prototype.computed), options.computed);
  ...
  function construct__combine(a, b) {
  	var c = a.slice(),
  	    i = b.length;
  ...
  function getAdaptors(ractive, protoAdapt, options) {
  	...
  	adapt = construct__combine(protoAdapt, adapt);
  ...
  function initialiseProperties(ractive) {
  	...
  	// existed
  	ractive._guid = 'r-' + construct__uid++;
  ...
  function HookQueue___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var HookQueue = (function () {
  	function HookQueue(event) {
  		HookQueue___classCallCheck(this, HookQueue);
  ...
  function ExpressionProxy___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function ExpressionProxy___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var ExpressionProxy = (function (_Model) {
  	ExpressionProxy___inherits(ExpressionProxy, _Model);

  	function ExpressionProxy(fragment, template) {
  		var _this = this;

  		ExpressionProxy___classCallCheck(this, ExpressionProxy);
  ...
  function ReferenceExpressionProxy___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function ReferenceExpressionProxy___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var ReferenceExpressionProxy = (function (_Model) {
  	ReferenceExpressionProxy___inherits(ReferenceExpressionProxy, _Model);

  	function ReferenceExpressionProxy(fragment, template) {
  		var _this = this;

  		ReferenceExpressionProxy___classCallCheck(this, ReferenceExpressionProxy);
  		...
  		this.base = resolvers_resolve(fragment, template);
  ...
  var resolvers_resolve = resolvers_resolve__resolve;
  function resolvers_resolve__resolve(fragment, template) {
  	if (template.r) {
  ...
  var updateLiveQueries__default = updateLiveQueries__updateLiveQueries;
  // TODO it's unfortunate that this has to run every time a
  // component is rendered... is there a better way?

  function updateLiveQueries__updateLiveQueries(component) {
  ...
  function items_Component___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function items_Component___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  function items_Component__makeDirty(query) {
  	query.makeDirty();
  }

  var items_Component__teardownHook = new Hook('teardown');

  var Component = (function (_Item) {
  	items_Component___inherits(Component, _Item);

  	function Component(options, ComponentConstructor) {
  		items_Component___classCallCheck(this, Component);
  			...
  			Object.keys(this.template.a).forEach(function (localKey) {
  				...
  				if (template === 0) {
  					...
  					if (template.length === 1 && template[0].t === INTERPOLATOR) {
  						var model = resolvers_resolve(_this.parentFragment, template[0]);
  	...
  	Component.prototype.rebind = function rebind() {
  		...
  		this.complexMappings.forEach(methodCallers__rebind);

  		this.liveQueries.forEach(items_Component__makeDirty);
  			...
  			(function () {
  				...
  				Object.keys(_this3.template.a).forEach(function (localKey) {
  					...
  					if (isArray(template) && template.length === 1 && template[0].t === INTERPOLATOR) {
  						var model = resolvers_resolve(_this3.parentFragment, template[0]);
  	...
  	Component.prototype.unbind = function unbind() {
  		this.complexMappings.forEach(methodCallers__unbind);
  		...
  		items_Component__teardownHook.fire(instance);
  	};
  ...
  var items_Component = Component;

  function Doctype___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Doctype___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Doctype = (function (_Item) {
  	Doctype___inherits(Doctype, _Item);

  	function Doctype() {
  		Doctype___classCallCheck(this, Doctype);
  ...
  function Attribute___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Attribute___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Attribute = (function (_Item) {
  	Attribute___inherits(Attribute, _Item);

  	function Attribute(options) {
  		Attribute___classCallCheck(this, Attribute);
  	...
  	Attribute.prototype.render = function render() {
  		...
  		if (!node.namespaceURI || node.namespaceURI === html) {
  			var propertyName = attribute_propertyNames[this.name] || this.name;
  ...
  function ConditionalAttribute___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function ConditionalAttribute___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var ConditionalAttribute__div = doc ? createElement('div') : null;

  var ConditionalAttribute = (function (_Item) {
  	ConditionalAttribute___inherits(ConditionalAttribute, _Item);

  	function ConditionalAttribute(options) {
  		ConditionalAttribute___classCallCheck(this, ConditionalAttribute);
  	...
  	ConditionalAttribute.prototype.render = function render() {
  		...
  		this.isSvg = this.node.namespaceURI === namespaces__svg;
  ...
  function parseAttributes(str, isSvg) {
  	...
  	ConditionalAttribute__div.innerHTML = '<' + tagName + ' ' + str + '></' + tagName + '>';
  ...
  function Decorator___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Decorator = (function () {
  	function Decorator(owner, template) {
  		Decorator___classCallCheck(this, Decorator);
  ...
  function EventHandler___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var EventHandler = (function () {
  	function EventHandler(owner, name, template) {
  		EventHandler___classCallCheck(this, EventHandler);
  ...
  var transitions_prefix__prefix, prefixCache, transitions_prefix__testStyle;

  if (!isClient) {
  	transitions_prefix__prefix = null;
  } else {
  	prefixCache = {};
  	transitions_prefix__testStyle = createElement('div').style;

  	transitions_prefix__prefix = function (prop) {
  		var i, vendor, capped;

  		prop = camelCase(prop);

  		if (!prefixCache[prop]) {
  			if (transitions_prefix__testStyle[prop] !== undefined) {
  				...
  				while (i--) {
  					vendor = vendors[i];
  					if (transitions_prefix__testStyle[vendor + capped] !== undefined) {
  ...
  var transitions_prefix = transitions_prefix__prefix;

  var visible = undefined;
  var hidden = 'hidden';

  if (doc) {
  	var visibility__prefix = undefined;

  	if (hidden in doc) {
  		visibility__prefix = '';
  	} else {
  		var visibility__i = vendors.length;
  		while (visibility__i--) {
  			var vendor = vendors[visibility__i];
  			hidden = vendor + 'Hidden';

  			if (hidden in doc) {
  				visibility__prefix = vendor;
  				doc.addEventListener(visibility__prefix + 'visibilitychange', onChange);
  				onChange();
  ...
  if (!isClient) {
  	...
  	createTransitions = function (t, to, options, changedProperties, resolve) {
  		...
  		setTimeout(function () {
  			...
  			t.node.style[TRANSITION_PROPERTY] = changedProperties.map(transitions_prefix).map(hyphenate).join(',');
  			...
  			setTimeout(function () {
  				...
  				while (i--) {
  					...
  					if (CSS_TRANSITIONS_ENABLED && !cannotUseCssTransitions[hash]) {
  						t.node.style[transitions_prefix(prop)] = to[prop];
  						...
  						if (!canUseCssTransitions[hash]) {
  							...
  							if (cannotUseCssTransitions[hash]) {
  								t.node.style[transitions_prefix(prop)] = originalValue;
  							}
  						}
  					}
  ...
  function Transition___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var getComputedStyle = win && (win.getComputedStyle || legacy.getComputedStyle);
  var resolved = utils_Promise.resolve();

  var Transition = (function () {
  	function Transition(owner, template, isIntro) {
  		Transition___classCallCheck(this, Transition);
  	...
  	Transition.prototype.animateStyle = function animateStyle(style, value, options) {
  		...
  		var promise = new utils_Promise(function (resolve) {
  			...
  			while (i--) {
  				...
  				current = computedStyle[transitions_prefix(prop)];
  				...
  				if (current != to[prop]) {
  					...
  					// e.g. height='auto'
  					_this.node.style[transitions_prefix(prop)] = current;
  				}
  			}
  	...
  	Transition.prototype.getStyle = function getStyle(props) {
  		...
  		if (typeof props === 'string') {
  			value = computedStyle[transitions_prefix(props)];
  			if (value === '0px') {
  				value = 0;
  			}
  			return value;
  		...
  		while (i--) {
  			prop = props[i];
  			value = computedStyle[transitions_prefix(prop)];
  			if (value === '0px') {
  				value = 0;
  			}
  			styles[prop] = value;
  	...
  	Transition.prototype.processParams = function processParams(params, defaults) {
  		...
  		return utils_object__extend({}, defaults, params);
  	};
  	...
  	Transition.prototype.setStyle = function setStyle(style, value) {
  		...
  		if (typeof style === 'string') {
  			this.node.style[transitions_prefix(style)] = value;
  		} else {
  			for (prop in style) {
  				if (style.hasOwnProperty(prop)) {
  					this.node.style[transitions_prefix(prop)] = style[prop];
  				}
  			}
  		}
  ...
  var element_updateLiveQueries = element_updateLiveQueries__updateLiveQueries;

  function element_updateLiveQueries__updateLiveQueries(element) {
  	// Does this need to be added to any live queries?
  	var node = element.node;
  ...
  function binding_Binding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var Binding = (function () {
  	function Binding(element) {
  		...
  		binding_Binding___classCallCheck(this, Binding);
  ...
  function CheckboxBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function CheckboxBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var CheckboxBinding = (function (_Binding) {
  	CheckboxBinding___inherits(CheckboxBinding, _Binding);

  	function CheckboxBinding(element) {
  		CheckboxBinding___classCallCheck(this, CheckboxBinding);
  ...
  function getBindingGroup___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var BindingGroup = (function () {
  	function BindingGroup(model, getValue) {
  		getBindingGroup___classCallCheck(this, BindingGroup);
  ...
  function CheckboxNameBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function CheckboxNameBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  function CheckboxNameBinding__getGroupValue() {
  ...
  var CheckboxNameBinding = (function (_Binding) {
  	CheckboxNameBinding___inherits(CheckboxNameBinding, _Binding);

  	function CheckboxNameBinding(element) {
  		CheckboxNameBinding___classCallCheck(this, CheckboxNameBinding);
  		...
  		this.group = getBindingGroup(this.ractive._guid, 'checkboxes', this.model, CheckboxNameBinding__getGroupValue);
  		this.group.add(this);
  ...
  function ContentEditableBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function ContentEditableBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var ContentEditableBinding = (function (_Binding) {
  	ContentEditableBinding___inherits(ContentEditableBinding, _Binding);

  	function ContentEditableBinding() {
  		ContentEditableBinding___classCallCheck(this, ContentEditableBinding);
  ...
  function FileListBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function FileListBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var FileListBinding = (function (_Binding) {
    FileListBinding___inherits(FileListBinding, _Binding);

    function FileListBinding() {
      FileListBinding___classCallCheck(this, FileListBinding);
  ...
  function GenericBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function GenericBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var GenericBinding = (function (_Binding) {
  	GenericBinding___inherits(GenericBinding, _Binding);

  	function GenericBinding() {
  		GenericBinding___classCallCheck(this, GenericBinding);
  ...
  function MultipleSelectBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function MultipleSelectBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var MultipleSelectBinding = (function (_Binding) {
  	MultipleSelectBinding___inherits(MultipleSelectBinding, _Binding);

  	function MultipleSelectBinding() {
  		MultipleSelectBinding___classCallCheck(this, MultipleSelectBinding);
  ...
  function NumericBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  function RadioBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var RadioBinding = (function (_Binding) {
  	RadioBinding___inherits(RadioBinding, _Binding);

  	function RadioBinding(element) {
  		RadioBinding___classCallCheck(this, RadioBinding);
  ...
  function RadioNameBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function RadioNameBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  function RadioNameBinding__getGroupValue() {
  	var i = this.bindings.length;
  	while (i--) {
  ...
  var RadioNameBinding = (function (_Binding) {
  	RadioNameBinding___inherits(RadioNameBinding, _Binding);

  	function RadioNameBinding(element) {
  		RadioNameBinding___classCallCheck(this, RadioNameBinding);

  		_Binding.call(this, element, 'name');

  		this.group = getBindingGroup(this.ractive._guid, 'radioname', this.model, RadioNameBinding__getGroupValue);
  		this.group.add(this);
  	}
  ...
  function SingleSelectBinding___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function SingleSelectBinding___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var SingleSelectBinding = (function (_Binding) {
  	SingleSelectBinding___inherits(SingleSelectBinding, _Binding);

  	function SingleSelectBinding() {
  		SingleSelectBinding___classCallCheck(this, SingleSelectBinding);
  ...
  function Element___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Element___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  function Element__makeDirty(query) {
  	query.makeDirty();
  }

  var Element = (function (_Item) {
  	Element___inherits(Element, _Item);

  	function Element(options) {
  		var _this = this;

  		Element___classCallCheck(this, Element);
  	...
  	Element.prototype.bind = function bind() {
  		this.attributes.forEach(methodCallers__bind);
  		this.conditionalAttributes.forEach(methodCallers__bind);
  		this.eventHandlers.forEach(methodCallers__bind);
  	...
  	Element.prototype.rebind = function rebind() {
  		this.attributes.forEach(methodCallers__rebind);
  		this.conditionalAttributes.forEach(methodCallers__rebind);
  		if (this.decorator) this.decorator.rebind();
  		if (this.fragment) this.fragment.rebind();
  		if (this.binding) this.binding.rebind();

  		this.liveQueries.forEach(Element__makeDirty);
  	};
  	...
  	Element.prototype.render = function render(target) {
  		...
  		this.attributes.forEach(methodCallers__render);
  		this.conditionalAttributes.forEach(methodCallers__render);
  		...
  		this.eventHandlers.forEach(methodCallers__render);

  		element_updateLiveQueries(this);
  	...
  	Element.prototype.update = function update() {
  		if (this.dirty) {
  			this.attributes.forEach(methodCallers__update);
  			this.conditionalAttributes.forEach(methodCallers__update);
  			this.eventHandlers.forEach(methodCallers__update);
  ...
  function getNamespace(element) {
  	...
  	if (element.name === 'svg') return namespaces__svg;
  ...
  function Form___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Form___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Form = (function (_Element) {
  	Form___inherits(Form, _Element);

  	function Form(options) {
  		Form___classCallCheck(this, Form);
  ...
  function Mustache___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Mustache___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Mustache = (function (_Item) {
  	Mustache___inherits(Mustache, _Item);

  	function Mustache(options) {
  		Mustache___classCallCheck(this, Mustache);
  	...
  	Mustache.prototype.bind = function bind() {
  		...
  		var model = resolvers_resolve(this.parentFragment, this.template);
  ...
  function Interpolator___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Interpolator___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Interpolator = (function (_Mustache) {
  	Interpolator___inherits(Interpolator, _Mustache);

  	function Interpolator() {
  		Interpolator___classCallCheck(this, Interpolator);
  ...
  function Input___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Input___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Input = (function (_Element) {
  	Input___inherits(Input, _Element);

  	function Input() {
  		Input___classCallCheck(this, Input);
  ...
  function Option___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Option___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var Option = (function (_Element) {
  	Option___inherits(Option, _Element);

  	function Option(options) {
  		Option___classCallCheck(this, Option);
  ...
  function Partial___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Partial___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Partial = (function (_Mustache) {
  	Partial___inherits(Partial, _Mustache);

  	function Partial() {
  		Partial___classCallCheck(this, Partial);
  ...
  function RepeatedFragment___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }
  ...
  var RepeatedFragment = (function () {
  	function RepeatedFragment(options) {
  		RepeatedFragment___classCallCheck(this, RepeatedFragment);
  	...
  	RepeatedFragment.prototype.toString = function toString(escape) {
  		return this.iterations ? this.iterations.map(escape ? toEscapedString : methodCallers__toString).join('') : '';
  	};

  	RepeatedFragment.prototype.unbind = function unbind() {
  		this.iterations.forEach(methodCallers__unbind);
  		return this;
  	};

  	RepeatedFragment.prototype.unrender = function unrender(shouldDestroy) {
  		this.iterations.forEach(shouldDestroy ? methodCallers__unrenderAndDestroy : methodCallers__unrender);
  		this.rendered = false;
  	};
  	...
  	RepeatedFragment.prototype.update = function update() {
  		...
  		this.iterations.forEach(methodCallers__update);
  ...
  function Section___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Section___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var Section = (function (_Mustache) {
  	Section___inherits(Section, _Mustache);

  	function Section(options) {
  		Section___classCallCheck(this, Section);
  ...
  function Select___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Select___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
  ...
  var Select = (function (_Element) {
  	Select___inherits(Select, _Element);

  	function Select(options) {
  		Select___classCallCheck(this, Select);
  ...
  function Text___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Text___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Text = (function (_Item) {
  	Text___inherits(Text, _Item);

  	function Text(options) {
  		Text___classCallCheck(this, Text);
  ...
  var insertHtml = function (html, node, docFrag) {
  	...
  	if (html != null && html !== '') {
  		...
  		} else if (node.namespaceURI === namespaces__svg) {
  			container = element('DIV');
  ...
  function Triple___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Triple___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Triple = (function (_Mustache) {
  	Triple___inherits(Triple, _Mustache);

  	function Triple(options) {
  		Triple___classCallCheck(this, Triple);
  ...
  function Yielder___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Yielder___inherits(subClass, superClass) { if (typeof superClass !== 'function' && superClass !== null) { throw new TypeError('Super expression must either be null or a function, not ' + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var Yielder = (function (_Item) {
  	Yielder___inherits(Yielder, _Item);

  	function Yielder(options) {
  		Yielder___classCallCheck(this, Yielder);
  ...
  var constructors = (_constructors = {}, _defineProperty(_constructors, DOCTYPE, Doctype), _defineProperty(_constructors, INTERPOLATOR, Interpolator), _defineProperty(_constructors, PARTIAL, Partial), _defineProperty(_constructors, SECTION, Section), _defineProperty(_constructors, TRIPLE, Triple), _defineProperty(_constructors, YIELDER, Yielder), _constructors);
  ...
  function createItem(options) {
  	...
  	if (options.template.t === ELEMENT) {
  		...
  		if (ComponentConstructor) {
  			return new items_Component(options, ComponentConstructor);
  		}
  ...
  function ReferenceResolver___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  var ReferenceResolver = (function () {
  	function ReferenceResolver(fragment, reference, callback) {
  		ReferenceResolver___classCallCheck(this, ReferenceResolver);
  ...
  function Fragment___classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError('Cannot call a class as a function'); } }

  function Fragment__unrenderAndDestroy(item) {
  	item.unrender(true);
  }

  var Fragment = (function () {
  	function Fragment(options) {
  		Fragment___classCallCheck(this, Fragment);
  	...
  	Fragment.prototype.bind = function bind(context) {
  		this.context = context;
  		this.items.forEach(methodCallers__bind);
  		this.bound = true;
  	...
  	Fragment.prototype.rebind = function rebind(context) {
  		...
  		this.items.forEach(methodCallers__rebind);
  	};
  	...
  	Fragment.prototype.toString = function toString(escape) {
  		return this.items.map(escape ? toEscapedString : methodCallers__toString).join('');
  	};

  	Fragment.prototype.unbind = function unbind() {
  		this.items.forEach(methodCallers__unbind);
  		this.bound = false;
  	...
  	Fragment.prototype.unrender = function unrender(shouldDestroy) {
  		this.items.forEach(shouldDestroy ? Fragment__unrenderAndDestroy : methodCallers__unrender);
  		this.rendered = false;
  	};

  	Fragment.prototype.update = function update() {
  		if (this.dirty) {
  			this.items.forEach(methodCallers__update);
  			this.dirty = false;
  		}
  	};
  ...
  var prototype_resetTemplate = Ractive$resetTemplate;
  ...
  var prototype_unrender = Ractive$unrender;
  var prototype_unrender__unrenderHook = new Hook('unrender');
  function Ractive$unrender() {
  	...
  	prototype_unrender__unrenderHook.fire(this);
  ...
  var prototype_update = Ractive$update;
  ...
  var prototype = {
  	...
  	resetTemplate: prototype_resetTemplate,
  	reverse: reverse,
  	set: prototype_set,
  	shift: shift,
  	sort: sort,
  ...
  var getNodeInfo = function (node) {
  	...
  	return {
  		...
  		index: utils_object__extend({}, storage.fragment.indexRefs),
  		key: utils_object__extend({}, storage.fragment.keyRefs)
  	};
  }
  ...
  utils_object__extend(Ractive.prototype, prototype, config_defaults);
