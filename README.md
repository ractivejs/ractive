...
*<b>BETANAUTS!</b> Help improve the next version of Ractive by trying out the [pre-release 0.3.8 builds](https://github.com/Rich-Harris/Ractive/tree/0.3.9/build) and [reporting any issues](https://github.com/Rich-Harris/Ractive/issues?state=open)!*
