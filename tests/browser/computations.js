...
export default function() {
  ...
  test('Computed value with a set() method', t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p>First name: Jim</p><p>Last name: Beam</p><p>Full name: Jim Beam</p>'
    );
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p>First name: Jim</p><p>Last name: Belushi</p><p>Full name: Jim Belushi</p>'
    );
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p>First name: John</p><p>Last name: Belushi</p><p>Full name: John Belushi</p>'
    );
  });
  ...
  test('Components can have default computed properties', t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      `<div style="width: 100px; height: 100px;">10000px squared</div>`
    );

    ractive.set('width', 200);
    t.htmlEqual(
      fixture.innerHTML,
      `<div style="width: 200px; height: 100px;">20000px squared</div>`
    );
  });
  ...
  test('Computed properties referencing bound parent data', t => {
    ...
    new Ractive({
      ...
      template: `
				...
				{{/each list}}`,
      data: {
        list: [{ opts: [3, 3, 3] }, { opts: [3, 2, 1] }, { opts: [1, 1, 1] }]
      },
      components: { List }
    });
  ...
  test('Computed values are only computed as necessary', t => {
    ...
    t.equal(
      fixture.innerHTML,
      'HOW LONG IS A PIECE OF COMPUTATION//HOW LONG IS A PIECE OF COMPUTATION'
    );
  ...
  test(`various spread expressions compute correctly`, t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      `[1,2,"a","b","c",{"bip":99,"bop":42,"0a":"z","1a":26,"2a":"y","3a":25,"4a":2,"5a":"zip","bif":84},123,2,1]`
    );
  });
