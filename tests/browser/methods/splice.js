...
export default function() {
  ...
  [true, false].forEach(modifyArrays => {
    test(`ractive.splice() (modifyArrays: ${modifyArrays})`, t => {
      ...
      t.htmlEqual(
        fixture.innerHTML,
        '<ul><li>alice</li><li>dave</li><li>eric</li><li>charles</li></ul>'
      );
      ...
      t.htmlEqual(
        fixture.innerHTML,
        '<ul><li>john</li><li>dave</li><li>eric</li><li>charles</li></ul>'
      );
      ...
      t.htmlEqual(
        fixture.innerHTML,
        '<ul><li>john</li><li>dave</li><li>eric</li><li>charles</li><li>larry</li></ul>'
      );
