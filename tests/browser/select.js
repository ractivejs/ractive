...
export default function() {
  ...
  test("If a select value with two-way binding has a selected option at render time, the model updates accordingly", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select><option value="red">red</option><option value="blue">blue</option><option value="green">green</option></select> <p>selected green</p>'
    );
  });
  ...
  test("If a select value with two-way binding has no selected option at render time, the model defaults to the top value", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select><option value="red">red</option><option value="blue">blue</option><option value="green">green</option></select> <p>selected red</p>'
    );
  });
...
test( 'If a multiple select value with two-way binding has a selected option at render time, the model updates accordingly', t => {
  ...
  test("If an empty select with a binding has options added to it, the model should update", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select><option value="1">one</option><option value="2">two</option></select><strong>Selected: 1</strong>'
    );
  });
  ...
  test("Regression test for #339", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p>0: <select><option value="red">Red</option></select></p><p>1: <select><option value="red">Red</option></select></p>'
    );
  ...
  test("Regression test for #351", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select multiple><option value="1">one</option><option value="2">two</option></select>'
    );
  });
  ...
  test("A select whose options are re-rendered will update its binding", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select><option value="a">a</option><option value="b">b</option><option value="c">c</option></select><p>selected: a</p>'
    );
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<select><option value="d">d</option><option value="e">e</option><option value="f">f</option></select><p>selected: d</p>'
    );
  });
  ...
  test("Disabled options have no implicit value (#786)", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p></p><select><option disabled>Select a letter</option><option value="a">a</option><option value="b">b</option><option value="c">c</option></select>'
    );
  });
  ...
  test("Uninitialised <select> elements will use the first *non-disabled* option", t => {
    ...
    t.htmlEqual(
      fixture.innerHTML,
      '<p>a</p><select><option disabled>Select a letter</option><option value="a">a</option><option value="b">b</option><option value="c">c</option></select>'
    );
