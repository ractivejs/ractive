...
export default class Fragment {
	constructor(options) {
		...
		this.componentParent = this.isRoot && this.ractive.component
			? this.ractive.component.parentFragment
			: null;
		this.delegate =
			(this.parent
	...
	findNextNode(item) {
		...
		if (this.isRoot) {
			if (this.ractive.component) {
				return this.ractive.component.parentFragment.findNextNode(
