...
if (!Array.prototype.every) {
  Array.prototype.every = function (callback, thisArg) {
    if (this === null || this === undefined) { throw new TypeError('Array.prototype.every called on null or undefined') }
...
if (!Array.prototype.reduce) {
  Array.prototype.reduce = function (callback, initialValue) {
    ...
    if (isInitialValuePresent) {
      ...
      if (!isViableInitialValueFromArray) { throw new TypeError('Reduce of empty array with no initial value') }
    }
...
if (!Object.create) {
  ...
  Object.create = function (prototype = {}, properties = {}) {
    if (prototype !== Object(prototype) && prototype !== null) { throw TypeError('Object prototype may only be an Object or null') }
