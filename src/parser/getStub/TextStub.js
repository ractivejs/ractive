...
(function () {
	...
	var htmlEntities, namedEntityPattern, hexEntityPattern, decimalEntityPattern, decodeCharacterReferences, whitespace;
	...
	decodeCharacterReferences = function ( html ) {
		...
		// decimal references
		result = result.replace( decimalEntityPattern, function ( match, num ) {
