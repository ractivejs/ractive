...
export default function construct(ractive, options) {
	...
	if (
		!options.hasOwnProperty('delegate') &&
		ractive.parent &&
	...
	while (i--) {
		...
		ractive[name] = Object.assign(
			Object.create(ractive.constructor[name] || null),
			options[name]
		);
	}
	...
	const computed = Object.assign(
		Object.create(ractive.constructor.prototype.computed),
		options.computed
	);
