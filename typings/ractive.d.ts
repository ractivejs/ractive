...
export type ComputationFn<T extends Ractive<T> = Ractive> = (
  this: T,
  context: any,
  keypath: string
) => any;
export type Computation<T extends Ractive<T> = Ractive> =
  | string
  | ComputationFn<T>
...
export type Decorator<T extends Ractive<T> = Ractive> = (
  this: T,
  node: HTMLElement,
  ...args: any[]
) => DecoratorHandle;
 ...
 */
export type ObserverCallback<T extends Ractive<T> = Ractive> = (
  this: T,
  value: any,
  old: any,
  keypath: string,
...
export type ObserverArrayCallback<T extends Ractive<T> = Ractive> = (
  this: T,
