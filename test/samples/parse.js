var parseTests = [
	...
	},
	{
		...
		template: '{{#foo[bar]}}{{.}}{{/}}',
		parsed: [{"t":4,"rx":{"r":"foo","m":[{"t":30,"n":"bar"}]},"f":[{"t":2,"r":"."}]}]
	},
	{
	...
	//From GH#541:
	{
		...
		parsed: [{"t":4,"r":"steps","i":"stepIndex","f":[{"t":4,"n":51,"rx":{"r":"hiddenSteps","m":[{"t":30,"n":"stepIndex"}]},"f":[{"t":7,"e":"p","f":[{"t":2,"rx":{"r":"hiddenSteps","m":[{"t":30,"n":"stepIndex"}]}}]}]}]}]
	},
	{
