var parseTests = [
	...
	},
	{
		...
		template: "a string",
		parsed: {v:2,t:["a string"]}
	},
	{
		name: "Interpolator",
		template: "{{mustache}}",
		parsed: {v:2,t:[{t:2,r:"mustache"}]}
	},
	{
		name: "Triple",
		template: "{{{mustache}}}",
		parsed: {v:2,t:[{t:3,r:"mustache"}]}
	},
	{
		name: "Static Interpolator",
		template: "[[mustache]]",
		parsed: {v:2,t:[{t:2,r:"mustache",s:true}]}
	},
	{
		name: "Static Triple",
		template: "[[[mustache]]]",
		parsed: {v:2,t:[{t:3,r:"mustache",s:true}]}
	},
	{
		name: "Static Section",
		template: "[[#foo]]yes[[/foo]]",
		parsed: {v:2,t:[{t:4,r:"foo",s:true,f:["yes"]}]}
	},
	{
		name: "Empty section",
		template: "{{#mustache}}{{/mustache}}",
		parsed: {v:2,t:[{t:4,r:"mustache"}]}
	},
	{
		name: "Section",
		template: "{{#mustache}}contents{{/mustache}}",
		parsed: {v:2,t:[{"f":["contents"],t:4,r:"mustache"}]}
	},
	{
		name: "Interpolator with preceding text",
		template: "preceding text {{mustache}}",
		parsed: {v:2,t:["preceding text ",{t:2,r:"mustache"}]}
	},
	{
		name: "Interpolator with following text",
		template: "{{mustache}} following text",
		parsed: {v:2,t:[{t:2,r:"mustache"}," following text"]}
	},
	{
	...
	},
	{
		...
		template: "<style type='text/css'>body { font-family: 'Comic Sans MS'; }</style>",
		parsed: {v:2,t:[{"a":{"type":"text/css"},"e":"style","f":["body { font-family: 'Comic Sans MS'; }"],"t":7}]},
		options: {
			sanitize: false
		}
	},
	{
		...
		template: "<link rel='{{rel}}'>",
		parsed: {v:2,t:[{a:{"rel":[{r:"rel",t:2}]},e:"link",t:7}]},
		options: {
			sanitize: false
		}
	},
	{
		...
		parsed: {v:2,t:[{"f":[{r:"text",t:2}],e:"p",t:7}]},
		options: {
			sanitize: true
		}
	},
	{
		...
		template: "<p onclick='doSomething();'>{{text}}</p>",
		parsed: {v:2,t:[{a:{"onclick":"doSomething();"},"f":[{r:"text",t:2}],e:"p",t:7}]},
		options: {
			sanitize: false
		}
	},
	{
		...
		parsed: {v:2,t:[{a:{"xmlns":"http://www.w3.org/2000/svg"},"f":[{a:{"cx":[{r:"x",t:2}],"cy":[{r:"y",t:2}],r:[{r:"r",t:2}]},e:"circle",t:7}],e:"svg",t:7}]}
	},
	{
		name: "SVG with non-mustache text",
		template: "<svg xmlns=\"http://www.w3.org/2000/svg\"><text>some text</text></svg>",
		parsed: {v:2,t:[{a:{"xmlns":"http://www.w3.org/2000/svg"},"f":[{"f":["some text"],e:"text",t:7}],e:"svg",t:7}]}
	},
	{
		name: "SVG with interpolator",
		template: "<svg xmlns=\"http://www.w3.org/2000/svg\"><text>{{hello}}</text></svg>",
		parsed: {v:2,t:[{a:{"xmlns":"http://www.w3.org/2000/svg"},"f":[{"f":[{r:"hello",t:2}],e:"text",t:7}],e:"svg",t:7}]}
	},
	{
		name: "SVG with interpolator and static text",
		template: "<svg xmlns=\"http://www.w3.org/2000/svg\"><text>Hello {{thing}}!</text></svg>",
		parsed: {v:2,t:[{a:{"xmlns":"http://www.w3.org/2000/svg"},"f":[{"f":["Hello ",{r:"thing",t:2},"!"],e:"text",t:7}],e:"svg",t:7}]}
	},
	{
		name: "Mixture of HTML-able and non-HTML-able elements in template",
		template: "<div><p>HTML</p><p>{{mustache}}</p></div>",
		parsed: {v:2,t:[{t:7,e:"div","f":[{t:7,e:"p","f":["HTML"]},{t:7,e:"p","f":[{t:2,r:"mustache"}]}]}]}
	},
	{
		name: "Expression mustache",
		template: "{{( i + 1 )}}",
		parsed: {v:2,t:[{t:2,"x":{r:["i"],"s":"_0+1"}}]}
	},
	{
	...
	//From GH#541:
	{
		...
		parsed: {v:2,t:[{"t":4,"r":"steps","i":"stepIndex","f":[{"t":4,"n":51,"rx":{"r":"hiddenSteps","m":[{"t":30,"n":"stepIndex"}]},"f":[{"t":7,"e":"p","f":[{"t":2,"rx":{"r":"hiddenSteps","m":[{"t":30,"n":"stepIndex"}]}}]}]}]}]}
	},
	{
	...
	},
	{
		...
		parsed: {v:2,t:[{t:4,n:50,r:'foo',f:['foo']}]}
	},
	{
		name: 'If syntax',
		template: '{{#if (foo*5 < 20)}}foo{{/if}}',
		parsed: {v:2,t:[{t:4,n:50,x:{r:['foo'],s:'_0*5<20'},f:['foo']}]}
	},
	{
	...
	},
	{
		...
		parsed: {v:2,t:[{t:4,n:51,r:'foo',f:['foo']}]}
	},
	{
		name: 'Unless syntax',
		template: '{{#unless (foo*5 < 20)}}foo{{/unless}}',
		parsed: {v:2,t:[{t:4,n:51,x:{r:['foo'],s:'_0*5<20'},f:['foo']}]}
	},
	{
		name: 'If else syntax',
		template: '{{#if foo}}foo{{else}}not foo{{/if}}',
		parsed: {v:2,t:[{t:4,b:1,n:50,r:'foo',f:['foo']},{t:4,n:50,x:{r:[],s:'true'},f:['not foo']}]}
	},
	{
		...
		template:
			...
			'	bar' +
			'{{/if}}',
		parsed: {v:2,t:[{t:4,b:1,n:50,r:'foo',f:['foo ',{t:4,b:1,n:50,r:'foo2',f:['foo2']},{t:4,n:50,x:{r:[],s:'true'},f:['not foo2']}]},{t:4,n:50,x:{r:[],s:'true'},f:['bar']}]}
	},
	{
		name: 'Each else syntax',
		template: '{{#each foo:i}}foo #{{i+1}}{{else}}no foos{{/each}}',
		parsed: {v:2,t:[{t:4,b:1,n:52,r:'foo',i:'i',f:['foo #',{ t:2,x:{r:['i'],s:'_0+1'}}]},{t:4,n:50,x:{r:[],s:'true'},f:['no foos']}]}
	},
	{
	...
	},
	{
		...
		parsed: {v:2,t:[{t:4,r:'foo',f:['normal']},{t:4,r:'foo',n:50,f:['handlebars']}]}
	},
	{
		name: 'Expression close syntax',
		template: '{{#(foo*5 < 20)}}foo{{/()}}',
		parsed: {v:2,t:[{t:4,x:{r:['foo'],s:'_0*5<20'},f:['foo']}]}
	},
	{
		name: "SVG trace",
		template:
		...
		parsed: {v:2,t:[{t:7,e:'svg',a:{xmlns:'http://www.w3.org/2000/svg'},f:[{t:7,e:'circle',a:{cx:[{t:2,r:'x',p:[2,15,55]}],cy:[{t:2,r:'y',p:[2,26,66]}],r:[{t:2,r:'r',p:[2,36,76]}]},p:[2,3,43]}],p:[1,1,0]}]}
	},
	{
		...
		template: 'hi{{name}}\n' +
			...
			'     {{/foo}}\n' +
			'</div>',
		parsed: {v:2,t:['hi',{t:2,p:[1,3,2],r:'name'},' ',{t:7,e:'div',p:[2,1,11],f:['blah ',{t:4,p:[3,6,26],r:'foo',f:['wew',{t:7,e:'span',p:[3,17,37],f:['Ain\'t that ',{t:2,p:[4,13,62],r:'grand'},'?']}]}]}]}
	},
	{
		name: "Mixture of HTML-able and non-HTML-able elements in template with Traces",
		template: "<div><p>HTML</p><p>{{mustache}}</p></div>",
		options: {includeLinePositions:true},
		parsed: {v:2,t:[{t:7,e:'div',p:[1,1,0],f:[{t:7,e:'p',p:[1,6,5],f:['HTML']},{t:7,e:'p',p:[1,17,16],f:[{t:2,p:[1,20,19],r:'mustache'}]}]}]}
	},
	{
		name: "Empty event attribute",
		template: "<p on-click=''></p>",
		parsed: {v:2,t:[{t:7,e:'p',v:{click:''}}]}
	},
	{
	...
	},
	{
		...
		parsed: {v:2,t:[{t:7,e:'div',v:{foo:'thiswillchange'}}]}
	},
	{
		name: 'Multiple proxy event names joined by "-"',
		template: '<div on-foo-bar="baz"></div>',
		parsed: {v:2,t:[{t:7,e:'div',v:{'foo-bar':'baz'}}]}
	},
	...
	// #1024
	{
		...
		parsed: {v:2,p:{a:['a']},t:['testing ',{t:7,e:'script',f:['alert()']}]}
	},
	...
	},
	{
		...
		template: '{{>item foo}}',
		parsed: {v:2,t:[{t:4,n:53,r:'foo',f:[{t:8,r:'item'}]}]}
	},
	...
	},
	{
		name: 'Non-comment 1',
		template: '{{!foo}}',
		parsed: {v:2,t:[{t:2,x:{r:['foo'],s:'!_0'}}]}
	},
	{
		name: 'Non-comment 2',
		template: '{{!foo.bar}}',
		parsed: {v:2,t:[{t:2,x:{r:['foo.bar'],s:'!_0'}}]}
	},
	{
		name: 'Non-comment 3',
		template: '{{!foo()}}',
	...
	},
	{
		...
		parsed: {v:2,t:[{t:7,e:'div',a:{contenteditable:0}}]}
	},
	{
		name: '{{else}} block in attribute',
		template: '<img src="{{#if mobile}}small{{else}}big{{/if}}.png">',
		parsed: {v:2,t:[{t:7,e:'img',a:{src:[{t:4,b:1,r:'mobile',n:50,f:['small']},{t:4,x:{r:[],s:'true'},n:50,f:['big']},'.png']}}]}
	},
	{
		name: 'Attributes can contain HTML (#1322)',
		template: '<div data-attr="{{#each array}}<div>{{this}}</div>{{/each}}"></div>',
		parsed: {v:2,t:[{t:7,e:'div',a:{'data-attr':[{t:4,n:52,r:'array',f:['<div>',{t:2,r:'.'},'</div>']}]}}]}
	},
	{
		name: 'Attributes can contain HTML (#1322)',
		template: '<div data-attr=\'{{#each array}}<div>{{this}}</div>{{/each}}\'></div>',
