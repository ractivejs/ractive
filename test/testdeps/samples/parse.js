var parseTests = [
	...
	},
	{
		...
		parsed: {v:3,t:[{t:4,b:1,n:50,r:'foo',f:['foo']},{t:4,n:50,x:{r:[],s:'true'},f:['not foo']}]}
	},
	{
		...
		template:
			...
			'	bar' +
			'{{/if}}',
		parsed: {v:3,t:[{t:4,b:1,n:50,r:'foo',f:['foo ',{t:4,b:1,n:50,r:'foo2',f:['foo2']},{t:4,n:50,x:{r:[],s:'true'},f:['not foo2']}]},{t:4,n:50,x:{r:[],s:'true'},f:['bar']}]}
	},
	{
		name: 'Each else syntax',
		template: '{{#each foo:i}}foo #{{i+1}}{{else}}no foos{{/each}}',
		parsed: {v:3,t:[{t:4,b:1,n:52,r:'foo',i:'i',f:['foo #',{ t:2,x:{r:['i'],s:'_0+1'}}]},{t:4,n:50,x:{r:[],s:'true'},f:['no foos']}]}
	},
	{
	...
	},
	{
		...
		parsed: {v:3,t:[{t:7,e:'img',a:{src:[{t:4,b:1,r:'mobile',n:50,f:['small']},{t:4,x:{r:[],s:'true'},n:50,f:['big']},'.png']}}]}
	},
	{
