define(['require','@ractivejs/core','./path/to/MyComponent.ractive.html','./path/to/MyOtherComponent.ractive.html','./path/to/YetAnotherComponent.ractive.html','hhgttg'], function(require, Ractive){
