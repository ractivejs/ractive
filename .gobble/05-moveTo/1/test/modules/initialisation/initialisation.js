define([ 'ractive' ], function ( Ractive ) {
	...
	return function () {
		...
		test( 'data is inherited from grand parent extend (gh-923)', function(t ) {
		...
		test( '"this" refers to ractive instance in init method with _super (gh-840)', function(t ) {
		...
		test( 'Non-script tag for template throws error', function(t ) {
			var div, ractive;
		...
		*/
		...
		test( 'Late-comer components on render still fire init', function(t ) {
