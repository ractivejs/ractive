define(['circular','utils/create','utils/hasOwnProperty','parse/Parser/expressions/conditional','parse/Parser/utils/flattenExpression'],function (circular, create, hasOwnProperty, getConditional, flattenExpression) {
	...
	Parser.prototype = {
		...
		getLinePos: function () {
			...
			return {
				...
				toJSON: function()  {return [ lineNum, charNum ]},
				toString: function()  {return (("line " + lineNum) + (" character " + charNum) + "")}
			};
		},
