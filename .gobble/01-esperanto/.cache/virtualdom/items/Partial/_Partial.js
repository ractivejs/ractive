define(['config/types','virtualdom/items/Partial/getPartialDescriptor','virtualdom/items/Partial/applyIndent','circular'],function (types, getPartialDescriptor, applyIndent, circular) {
