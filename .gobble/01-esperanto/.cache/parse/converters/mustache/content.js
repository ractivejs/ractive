define(['config/types','parse/converters/mustache/type','parse/converters/mustache/handlebarsBlockCodes','legacy'],function (types, mustacheType, handlebarsBlockCodes) {
