define([
	...
	return function () {
		...
		test( 'can call _super on parent', function ( t ) {
			...
			var parent = { talk: function()  {return t.ok( true )} },
		...
		test( 'can find _super in prototype chain', function ( t ) {
			...
			var grandparent = { talk: function()  {return t.ok( true )} },
		...
		test( 'parent _super can be added later', function ( t ) {
			...
			parent.talk = function()  {return t.ok( true )};
		...
		test( 'parent instance can be changed', function ( t ) {
			...
			var parent = { talk: function()  {return false} },
				newParent = { talk: function()  {return t.ok( true )} },
				instance = create( parent );
