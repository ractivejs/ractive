define(['config/types','utils/create','virtualdom/Fragment/prototype/init/createItem'],function (types, create, createItem) {

	'use strict';
	
	return function Fragment$init ( options ) {var this$0 = this;
		...
		this.items = options.template.map( function( template, i )  {return createItem({
