define(['circular','utils/isArray','utils/isEqual'],function (circular, isArray, isEqual) {

	'use strict';
	
	var runloop;
	
	circular.push( function()  {return runloop = circular.runloop} );
	...
	Binding.prototype = {
		setValue: function ( value ) {var this$0 = this;
			...
			if ( !isEqual( value, this.value ) ) {
				...
				runloop.scheduleTask( function()  {return this$0.updating = false} );
			}
		},
